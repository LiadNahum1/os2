...
main(int argc, char *argv[]){
   ...
   f:	83 ec 10             	sub    $0x10,%esp
    ...
    int pid = getpid();
  12:	e8 6b 03 00 00       	call   382 <getpid>
  ...
  1a:	89 c3                	mov    %eax,%ebx
    printf(1, "malloc\n");
  1c:	68 ca 07 00 00       	push   $0x7ca
  21:	6a 01                	push   $0x1
  23:	e8 38 04 00 00       	call   460 <printf>
    act.sa_handler = &signal_handler;
    act.sigmask = 0;
    sigaction(6, &act, null); 
  28:	8d 45 f0             	lea    -0x10(%ebp),%eax
  2b:	83 c4 0c             	add    $0xc,%esp
    act.sa_handler = &signal_handler;
  2e:	c7 45 f0 90 00 00 00 	movl   $0x90,-0x10(%ebp)
    sigaction(6, &act, null); 
  35:	6a 00                	push   $0x0
    act.sigmask = 0;
  ...
  3e:	50                   	push   %eax
  3f:	6a 06                	push   $0x6
  41:	e8 64 03 00 00       	call   3aa <sigaction>
    printf(1, "sigaction\n");
  46:	58                   	pop    %eax
  47:	5a                   	pop    %edx
  48:	68 d2 07 00 00       	push   $0x7d2
  4d:	6a 01                	push   $0x1
  4f:	e8 0c 04 00 00       	call   460 <printf>
  ...
  56:	6a 06                	push   $0x6
  58:	53                   	push   %ebx
  59:	e8 d4 02 00 00       	call   332 <kill>
  5e:	83 c4 0c             	add    $0xc,%esp
  61:	50                   	push   %eax
  62:	68 dd 07 00 00       	push   $0x7dd
  67:	6a 01                	push   $0x1
  69:	e8 f2 03 00 00       	call   460 <printf>
    printf(1, "after sig handler");
  6e:	58                   	pop    %eax
  6f:	5a                   	pop    %edx
  70:	68 e5 07 00 00       	push   $0x7e5
  75:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb f7 07 00 00       	mov    $0x7f7,%ebx
        while(*s != 0){
