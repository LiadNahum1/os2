...
main(int argc, char **argv)
{
  ...
  int child = fork();
  12:	e8 13 03 00 00       	call   32a <fork>
  	wait();
  }
  ...
  19:	75 45                	jne    60 <main+0x60>

  	handler.sa_handler = &some_handler;
  	handler.sigmask = 0;
  	
  	sigaction(signum, &handler, null);
  1b:	8d 45 f0             	lea    -0x10(%ebp),%eax
  1e:	83 ec 04             	sub    $0x4,%esp
  	handler.sa_handler = &some_handler;
  21:	c7 45 f0 c0 00 00 00 	movl   $0xc0,-0x10(%ebp)
  	sigaction(signum, &handler, null);
  28:	6a 00                	push   $0x0
  	handler.sigmask = 0;
  ...
  31:	50                   	push   %eax
  32:	6a 04                	push   $0x4
  34:	e8 a1 03 00 00       	call   3da <sigaction>
  ...
  43:	68 fc 07 00 00       	push   $0x7fc
  48:	6a 01                	push   $0x1
  4a:	e8 41 04 00 00       	call   490 <printf>
		sleep(100);  		
  4f:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  56:	e8 67 03 00 00       	call   3c2 <sleep>
  5b:	83 c4 10             	add    $0x10,%esp
  5e:	eb e0                	jmp    40 <main+0x40>
  	}
  }
  else {
  	sleep(300);
  ...
  65:	68 2c 01 00 00       	push   $0x12c
  6a:	e8 53 03 00 00       	call   3c2 <sleep>
  ...
  71:	6a 04                	push   $0x4
  73:	53                   	push   %ebx
  74:	e8 e9 02 00 00       	call   362 <kill>
  	printf(1, "Send signal 4 to child\n");
  79:	59                   	pop    %ecx
  7a:	58                   	pop    %eax
  7b:	68 03 08 00 00       	push   $0x803
  80:	6a 01                	push   $0x1
  82:	e8 09 04 00 00       	call   490 <printf>
  	sleep(300);
  87:	c7 04 24 2c 01 00 00 	movl   $0x12c,(%esp)
  8e:	e8 2f 03 00 00       	call   3c2 <sleep>
  	kill(child, SIGKILL);
  93:	58                   	pop    %eax
  94:	5a                   	pop    %edx
  95:	6a 09                	push   $0x9
  97:	53                   	push   %ebx
  98:	e8 c5 02 00 00       	call   362 <kill>
  	printf(1, "Sent SIGKILL to child\n");
  9d:	59                   	pop    %ecx
  9e:	5b                   	pop    %ebx
  9f:	68 1b 08 00 00       	push   $0x81b
  a4:	6a 01                	push   $0x1
  a6:	e8 e5 03 00 00       	call   490 <printf>
  	wait();
  ab:	e8 8a 02 00 00       	call   33a <wait>
  }

  exit();
  b0:	e8 7d 02 00 00       	call   332 <exit>
  b5:	66 90                	xchg   %ax,%ax
  b7:	66 90                	xchg   %ax,%ax
  b9:	66 90                	xchg   %ax,%ax
  bb:	66 90                	xchg   %ax,%ax
...
000000c0 <some_handler>:
void some_handler(int signum) {
  c0:	55                   	push   %ebp
  c1:	89 e5                	mov    %esp,%ebp
  c3:	83 ec 0c             	sub    $0xc,%esp
	printf(1, "Recevied signal %d\n", signum);
  c6:	ff 75 08             	pushl  0x8(%ebp)
  c9:	68 e8 07 00 00       	push   $0x7e8
  ce:	6a 01                	push   $0x1
  d0:	e8 bb 03 00 00       	call   490 <printf>
}
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 32 08 00 00       	mov    $0x832,%ebx
        while(*s != 0){
