...
static inline int cas (volatile void * addr, int expected, int newval)
{
  ...
  asm volatile("movl %2 , %%eax\n\t"
   f:	bb 05 00 00 00       	mov    $0x5,%ebx
    printf(1, "starting....\n");
  14:	83 ec 08             	sub    $0x8,%esp
  17:	68 68 07 00 00       	push   $0x768
  1c:	6a 01                	push   $0x1
  1e:	e8 ed 03 00 00       	call   410 <printf>
    int* addr =malloc(sizeof(int));
  23:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  2a:	e8 41 06 00 00       	call   670 <malloc>
  2f:	ba 03 00 00 00       	mov    $0x3,%edx
  34:	89 c1                	mov    %eax,%ecx
    *addr = 3; 
  36:	c7 00 03 00 00 00    	movl   $0x3,(%eax)
  3c:	89 d0                	mov    %edx,%eax
  3e:	f0 0f b1 19          	lock cmpxchg %ebx,(%ecx)
  42:	9c                   	pushf  
  43:	5a                   	pop    %edx
  44:	83 e2 40             	and    $0x40,%edx
    printf(1, "cas : %d addr: %d", *((int*)cas(addr, 3, 5)), *addr);
  47:	6a 03                	push   $0x3
  49:	ff 32                	pushl  (%edx)
  4b:	68 76 07 00 00       	push   $0x776
  50:	6a 01                	push   $0x1
