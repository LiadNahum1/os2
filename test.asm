...
main(int argc, char *argv[]){
  ...
  18:	e8 e3 03 00 00       	call   400 <printf>
    ...
    //printf(1, "kill");*/
    exit();
  1d:	e8 80 02 00 00       	call   2a2 <exit>
  22:	66 90                	xchg   %ax,%ax
  24:	66 90                	xchg   %ax,%ax
  26:	66 90                	xchg   %ax,%ax
  28:	66 90                	xchg   %ax,%ax
...
00000030 <signal_handler>:
void signal_handler(int signum){
  30:	55                   	push   %ebp
  31:	89 e5                	mov    %esp,%ebp
  33:	83 ec 10             	sub    $0x10,%esp
    printf(1, "In signal handler");
  36:	68 58 07 00 00       	push   $0x758
  3b:	6a 01                	push   $0x1
  3d:	e8 be 03 00 00       	call   400 <printf>
}
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb 77 07 00 00       	mov    $0x777,%ebx
        while(*s != 0){
 ...
 5d1:	a1 44 0a 00 00       	mov    0xa44,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 44 0a 00 00       	mov    %eax,0xa44
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 44 0a 00 00       	mov    %eax,0xa44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
    ...
    if(p == freep)
 6b1:	39 05 44 0a 00 00    	cmp    %eax,0xa44
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 44 0a 00 00    	mov    0xa44,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 44 0a 00 00    	mov    %edx,0xa44
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 44 0a 00 00 48 	movl   $0xa48,0xa44
 727:	0a 00 00 
 72a:	c7 05 48 0a 00 00 48 	movl   $0xa48,0xa48
 731:	0a 00 00 
    base.s.size = 0;
 734:	b8 48 0a 00 00       	mov    $0xa48,%eax
 739:	c7 05 4c 0a 00 00 00 	movl   $0x0,0xa4c
 740:	00 00 00 
