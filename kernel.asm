...
80102121:	e8 2a 1f 00 00       	call   80104050 <wakeup>
...
801021e9:	e8 a2 1c 00 00       	call   80103e90 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102bf5:	e8 96 12 00 00       	call   80103e90 <sleep>
...
80102d42:	00 00 00 
    wakeup(&log);
80102d45:	e8 06 13 00 00       	call   80104050 <wakeup>
    release(&log.lock);
...
80102d70:	e8 db 12 00 00       	call   80104050 <wakeup>
  release(&log.lock);
...
80102eaa:	e8 01 0d 00 00       	call   80103bb0 <scheduler>
80102eaf:	90                   	nop
...
801033af:	e8 9c 0c 00 00       	call   80104050 <wakeup>
...
801033f4:	e8 57 0c 00 00       	call   80104050 <wakeup>
...
80103484:	e8 c7 0b 00 00       	call   80104050 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103489:	5a                   	pop    %edx
8010348a:	59                   	pop    %ecx
8010348b:	53                   	push   %ebx
8010348c:	56                   	push   %esi
8010348d:	e8 fe 09 00 00       	call   80103e90 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103513:	e8 38 0b 00 00       	call   80104050 <wakeup>
  release(&p->lock);
...
80103575:	e8 16 09 00 00       	call   80103e90 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103607:	e8 44 0a 00 00       	call   80104050 <wakeup>
  release(&p->lock);
...
8010364b:	e8 80 11 00 00       	call   801047d0 <release>
  if (first) {
...
80103696:	68 b5 78 10 80       	push   $0x801078b5
8010369b:	68 20 2d 11 80       	push   $0x80112d20
801036a0:	e8 2b 0f 00 00       	call   801045d0 <initlock>
}
...
80103754:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103757:	e8 e4 0e 00 00       	call   80104640 <pushcli>
  c = mycpu();
8010375c:	e8 4f ff ff ff       	call   801036b0 <mycpu>
  p = c->proc;
80103761:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103767:	e8 14 0f 00 00       	call   80104680 <popcli>
}
...
8010378c:	e8 7f 0f 00 00       	call   80104710 <acquire>
  pid = nextpid++;
...
801037a1:	a3 04 a0 10 80       	mov    %eax,0x8010a004
  release(&ptable.lock);
801037a6:	e8 25 10 00 00       	call   801047d0 <release>
}
...
801037c5:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
801037ca:	83 ec 0c             	sub    $0xc,%esp
801037cd:	68 20 2d 11 80       	push   $0x80112d20
801037d2:	e8 39 0f 00 00       	call   80104710 <acquire>
801037d7:	83 c4 10             	add    $0x10,%esp
801037da:	eb 16                	jmp    801037f2 <allocproc+0x32>
801037dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037e0:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
801037e6:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
801037ec:	0f 83 86 00 00 00    	jae    80103878 <allocproc+0xb8>
    if(p->state == UNUSED)
...
80103808:	e8 c3 0f 00 00       	call   801047d0 <release>
  p->pid = allocpid();
...
80103824:	74 6d                	je     80103893 <allocproc+0xd3>
  sp -= sizeof *p->tf;
80103826:	8d 80 b4 0f 00 00    	lea    0xfb4(%eax),%eax
  memset(p->context, 0, sizeof *p->context);
8010382c:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->tf;
8010382f:	89 43 18             	mov    %eax,0x18(%ebx)
  sp -= sizeof *p->context;
80103832:	8d 86 9c 0f 00 00    	lea    0xf9c(%esi),%eax
  *(uint*)sp = (uint)trapret;
80103838:	c7 86 b0 0f 00 00 df 	movl   $0x80105adf,0xfb0(%esi)
8010383f:	5a 10 80 
  sp -= sizeof *p->backup;
80103842:	81 c6 50 0f 00 00    	add    $0xf50,%esi
  p->context = (struct context*)sp;
80103848:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010384b:	6a 14                	push   $0x14
8010384d:	6a 00                	push   $0x0
8010384f:	50                   	push   %eax
80103850:	e8 cb 0f 00 00       	call   80104820 <memset>
  p->context->eip = (uint)forkret;
80103855:	8b 43 1c             	mov    0x1c(%ebx),%eax
  return p;
80103858:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
8010385b:	c7 40 10 40 36 10 80 	movl   $0x80103640,0x10(%eax)
  sp -= sizeof *p->backup;
80103862:	89 b3 04 01 00 00    	mov    %esi,0x104(%ebx)
}
...
80103882:	e8 49 0f 00 00       	call   801047d0 <release>
  return 0;
80103887:	83 c4 10             	add    $0x10,%esp
}
8010388a:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010388d:	89 d8                	mov    %ebx,%eax
8010388f:	5b                   	pop    %ebx
80103890:	5e                   	pop    %esi
80103891:	5d                   	pop    %ebp
80103892:	c3                   	ret    
...
80103893:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return 0;
8010389a:	31 db                	xor    %ebx,%ebx
8010389c:	eb ca                	jmp    80103868 <allocproc+0xa8>
...
801038b3:	e8 f8 37 00 00       	call   801070b0 <setupkvm>
801038b8:	85 c0                	test   %eax,%eax
801038ba:	89 43 04             	mov    %eax,0x4(%ebx)
801038bd:	0f 84 fa 00 00 00    	je     801039bd <userinit+0x11d>
...
801038d1:	e8 ba 34 00 00       	call   80106d90 <inituvm>
...
801038e6:	e8 35 0f 00 00       	call   80104820 <memset>
...
8010393f:	68 e5 78 10 80       	push   $0x801078e5
80103944:	50                   	push   %eax
80103945:	e8 b6 10 00 00       	call   80104a00 <safestrcpy>
  p->cwd = namei("/");
8010394a:	c7 04 24 ee 78 10 80 	movl   $0x801078ee,(%esp)
80103951:	e8 ba e5 ff ff       	call   80101f10 <namei>
80103956:	8d 93 04 01 00 00    	lea    0x104(%ebx),%edx
8010395c:	89 43 68             	mov    %eax,0x68(%ebx)
8010395f:	8d 83 84 00 00 00    	lea    0x84(%ebx),%eax
  p->signal_mask = 0;
80103965:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
8010396c:	00 00 00 
  p->pending_signals =0;
8010396f:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
80103976:	83 c4 10             	add    $0x10,%esp
  p->suspended =0;
80103979:	c7 83 08 01 00 00 00 	movl   $0x0,0x108(%ebx)
80103980:	00 00 00 
80103983:	90                   	nop
80103984:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    p->signal_handlers[i] = (void*)SIG_DFL;
80103988:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
8010398e:	83 c0 04             	add    $0x4,%eax
  for(int i=0; i<32; i++){
80103991:	39 d0                	cmp    %edx,%eax
80103993:	75 f3                	jne    80103988 <userinit+0xe8>
  acquire(&ptable.lock);
80103995:	83 ec 0c             	sub    $0xc,%esp
80103998:	68 20 2d 11 80       	push   $0x80112d20
8010399d:	e8 6e 0d 00 00       	call   80104710 <acquire>
  p->state = RUNNABLE;
801039a2:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801039a9:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801039b0:	e8 1b 0e 00 00       	call   801047d0 <release>
}
801039b5:	83 c4 10             	add    $0x10,%esp
801039b8:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801039bb:	c9                   	leave  
801039bc:	c3                   	ret    
    panic("userinit: out of memory?");
801039bd:	83 ec 0c             	sub    $0xc,%esp
801039c0:	68 cc 78 10 80       	push   $0x801078cc
...
801039d8:	e8 63 0c 00 00       	call   80104640 <pushcli>
  c = mycpu();
801039dd:	e8 ce fc ff ff       	call   801036b0 <mycpu>
  p = c->proc;
...
80103a96:	0f 84 ec 00 00 00    	je     80103b88 <fork+0x138>
  np->sz = curproc->sz;
...
80103b0f:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
  np->suspended = 0;
...
80103b1a:	8b 7a 10             	mov    0x10(%edx),%edi
  np->signal_mask = curproc->signal_mask;
80103b1d:	89 82 80 00 00 00    	mov    %eax,0x80(%edx)
  np->pending_signals = 0; 
80103b23:	c7 42 7c 00 00 00 00 	movl   $0x0,0x7c(%edx)
  np->suspended = 0;
80103b2a:	c7 82 08 01 00 00 00 	movl   $0x0,0x108(%edx)
80103b31:	00 00 00 
80103b34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    np->signal_handlers[i] = curproc->signal_handlers[i];
80103b38:	8b b4 8b 84 00 00 00 	mov    0x84(%ebx,%ecx,4),%esi
80103b3f:	89 b4 8a 84 00 00 00 	mov    %esi,0x84(%edx,%ecx,4)
  for(int i=0; i<32; i++){
80103b46:	83 c1 01             	add    $0x1,%ecx
80103b49:	83 f9 20             	cmp    $0x20,%ecx
80103b4c:	75 ea                	jne    80103b38 <fork+0xe8>
  acquire(&ptable.lock);
80103b4e:	83 ec 0c             	sub    $0xc,%esp
80103b51:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80103b54:	68 20 2d 11 80       	push   $0x80112d20
80103b59:	e8 b2 0b 00 00       	call   80104710 <acquire>
  np->state = RUNNABLE;
80103b5e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103b61:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  release(&ptable.lock);
80103b68:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103b6f:	e8 5c 0c 00 00       	call   801047d0 <release>
  return pid;
80103b74:	83 c4 10             	add    $0x10,%esp
}
80103b77:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103b7a:	89 f8                	mov    %edi,%eax
80103b7c:	5b                   	pop    %ebx
80103b7d:	5e                   	pop    %esi
80103b7e:	5f                   	pop    %edi
80103b7f:	5d                   	pop    %ebp
80103b80:	c3                   	ret    
    return -1;
80103b81:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80103b86:	eb ef                	jmp    80103b77 <fork+0x127>
    kfree(np->kstack);
80103b88:	83 ec 0c             	sub    $0xc,%esp
80103b8b:	ff 72 08             	pushl  0x8(%edx)
    return -1;
80103b8e:	bf ff ff ff ff       	mov    $0xffffffff,%edi
    kfree(np->kstack);
80103b93:	e8 a8 e7 ff ff       	call   80102340 <kfree>
    np->kstack = 0;
80103b98:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    return -1;
80103b9b:	83 c4 10             	add    $0x10,%esp
    np->kstack = 0;
80103b9e:	c7 42 08 00 00 00 00 	movl   $0x0,0x8(%edx)
    np->state = UNUSED;
80103ba5:	c7 42 0c 00 00 00 00 	movl   $0x0,0xc(%edx)
    return -1;
80103bac:	eb c9                	jmp    80103b77 <fork+0x127>
...
80103bb6:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103bb9:	e8 f2 fa ff ff       	call   801036b0 <mycpu>
...
80103bde:	e8 2d 0b 00 00       	call   80104710 <acquire>
...
80103c00:	e8 7b 30 00 00       	call   80106c80 <switchuvm>
...
80103c0b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c12:	e8 44 0e 00 00       	call   80104a5b <swtch>
      switchkvm();
80103c17:	e8 44 30 00 00       	call   80106c60 <switchkvm>
      c->proc = 0;
80103c1c:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103c23:	00 00 00 
80103c26:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c29:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
80103c2f:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
80103c35:	72 b9                	jb     80103bf0 <scheduler+0x40>
    release(&ptable.lock);
80103c37:	83 ec 0c             	sub    $0xc,%esp
80103c3a:	68 20 2d 11 80       	push   $0x80112d20
80103c3f:	e8 8c 0b 00 00       	call   801047d0 <release>
    sti();
...
80103c54:	53                   	push   %ebx
  pushcli();
80103c55:	e8 e6 09 00 00       	call   80104640 <pushcli>
  c = mycpu();
80103c5a:	e8 51 fa ff ff       	call   801036b0 <mycpu>
  p = c->proc;
80103c5f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c65:	e8 16 0a 00 00       	call   80104680 <popcli>
  if(!holding(&ptable.lock))
80103c6a:	83 ec 0c             	sub    $0xc,%esp
80103c6d:	68 20 2d 11 80       	push   $0x80112d20
80103c72:	e8 69 0a 00 00       	call   801046e0 <holding>
80103c77:	83 c4 10             	add    $0x10,%esp
80103c7a:	85 c0                	test   %eax,%eax
80103c7c:	74 4f                	je     80103ccd <sched+0x7d>
  if(mycpu()->ncli != 1)
80103c7e:	e8 2d fa ff ff       	call   801036b0 <mycpu>
...
80103c97:	75 41                	jne    80103cda <sched+0x8a>
  intena = mycpu()->intena;
80103c99:	e8 12 fa ff ff       	call   801036b0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103c9e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103ca1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103ca7:	e8 04 fa ff ff       	call   801036b0 <mycpu>
80103cac:	83 ec 08             	sub    $0x8,%esp
80103caf:	ff 70 04             	pushl  0x4(%eax)
80103cb2:	53                   	push   %ebx
80103cb3:	e8 a3 0d 00 00       	call   80104a5b <swtch>
  mycpu()->intena = intena;
80103cb8:	e8 f3 f9 ff ff       	call   801036b0 <mycpu>
}
...
80103d19:	e8 22 09 00 00       	call   80104640 <pushcli>
  c = mycpu();
80103d1e:	e8 8d f9 ff ff       	call   801036b0 <mycpu>
  p = c->proc;
80103d23:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103d29:	e8 52 09 00 00       	call   80104680 <popcli>
  if(curproc == initproc)
...
80103d4a:	e8 21 d1 ff ff       	call   80100e70 <fileclose>
      curproc->ofile[fd] = 0;
...
80103d5d:	75 e1                	jne    80103d40 <exit+0x30>
  begin_op();
80103d5f:	e8 6c ee ff ff       	call   80102bd0 <begin_op>
  iput(curproc->cwd);
80103d64:	83 ec 0c             	sub    $0xc,%esp
80103d67:	ff 76 68             	pushl  0x68(%esi)
80103d6a:	e8 71 da ff ff       	call   801017e0 <iput>
  end_op();
80103d6f:	e8 cc ee ff ff       	call   80102c40 <end_op>
  curproc->cwd = 0;
80103d74:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103d7b:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d82:	e8 89 09 00 00       	call   80104710 <acquire>
...
80103d98:	05 0c 01 00 00       	add    $0x10c,%eax
80103d9d:	3d 54 70 11 80       	cmp    $0x80117054,%eax
...
80103daf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103db6:	05 0c 01 00 00       	add    $0x10c,%eax
80103dbb:	3d 54 70 11 80       	cmp    $0x80117054,%eax
...
80103dcf:	90                   	nop
80103dd0:	81 c2 0c 01 00 00    	add    $0x10c,%edx
80103dd6:	81 fa 54 70 11 80    	cmp    $0x80117054,%edx
...
80103df8:	05 0c 01 00 00       	add    $0x10c,%eax
80103dfd:	3d 54 70 11 80       	cmp    $0x80117054,%eax
...
80103e27:	68 3d 79 10 80       	push   $0x8010793d
80103e2c:	e8 5f c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103e31:	83 ec 0c             	sub    $0xc,%esp
80103e34:	68 30 79 10 80       	push   $0x80107930
...
80103e4c:	e8 bf 08 00 00       	call   80104710 <acquire>
  pushcli();
80103e51:	e8 ea 07 00 00       	call   80104640 <pushcli>
  c = mycpu();
80103e56:	e8 55 f8 ff ff       	call   801036b0 <mycpu>
  p = c->proc;
80103e5b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e61:	e8 1a 08 00 00       	call   80104680 <popcli>
...
80103e79:	e8 52 09 00 00       	call   801047d0 <release>
}
...
80103e9c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103e9f:	e8 9c 07 00 00       	call   80104640 <pushcli>
  c = mycpu();
80103ea4:	e8 07 f8 ff ff       	call   801036b0 <mycpu>
  p = c->proc;
80103ea9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103eaf:	e8 cc 07 00 00       	call   80104680 <popcli>
  if(p == 0)
...
80103ed0:	e8 3b 08 00 00       	call   80104710 <acquire>
    release(lk);
80103ed5:	89 34 24             	mov    %esi,(%esp)
80103ed8:	e8 f3 08 00 00       	call   801047d0 <release>
  p->chan = chan;
...
80103efa:	e8 d1 08 00 00       	call   801047d0 <release>
    acquire(lk);
...
80103f0b:	5d                   	pop    %ebp
    acquire(lk);
80103f0c:	e9 ff 07 00 00       	jmp    80104710 <acquire>
...
80103f39:	68 4f 79 10 80       	push   $0x8010794f
80103f3e:	e8 4d c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103f43:	83 ec 0c             	sub    $0xc,%esp
80103f46:	68 49 79 10 80       	push   $0x80107949
...
80103f54:	53                   	push   %ebx
  pushcli();
80103f55:	e8 e6 06 00 00       	call   80104640 <pushcli>
  c = mycpu();
80103f5a:	e8 51 f7 ff ff       	call   801036b0 <mycpu>
  p = c->proc;
80103f5f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f65:	e8 16 07 00 00       	call   80104680 <popcli>
  acquire(&ptable.lock);
...
80103f88:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
80103f8e:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
...
80103f9f:	74 37                	je     80103fd8 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fa1:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
      havekids = 1;
80103fa7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fac:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
...
80103fde:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103fe1:	e8 5a e3 ff ff       	call   80102340 <kfree>
        freevm(p->pgdir);
80103fe6:	5a                   	pop    %edx
...
80103fea:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ff1:	e8 3a 30 00 00       	call   80107030 <freevm>
        release(&ptable.lock);
...
80104016:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010401d:	e8 ae 07 00 00       	call   801047d0 <release>
        return pid;
...
8010403b:	e8 90 07 00 00       	call   801047d0 <release>
      return -1;
...
8010405f:	e8 ac 06 00 00       	call   80104710 <acquire>
...
80104070:	05 0c 01 00 00       	add    $0x10c,%eax
80104075:	3d 54 70 11 80       	cmp    $0x80117054,%eax
...
80104087:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010408e:	05 0c 01 00 00       	add    $0x10c,%eax
80104093:	3d 54 70 11 80       	cmp    $0x80117054,%eax
...
801040a4:	c9                   	leave  
  release(&ptable.lock);
801040a5:	e9 26 07 00 00       	jmp    801047d0 <release>
...
801040b3:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801040b6:	8b 55 08             	mov    0x8(%ebp),%edx
  if (signum > 31 || signum < 0)
801040b9:	83 f9 1f             	cmp    $0x1f,%ecx
801040bc:	77 32                	ja     801040f0 <kill+0x40>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040be:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801040c3:	eb 0f                	jmp    801040d4 <kill+0x24>
801040c5:	8d 76 00             	lea    0x0(%esi),%esi
801040c8:	05 0c 01 00 00       	add    $0x10c,%eax
801040cd:	3d 54 70 11 80       	cmp    $0x80117054,%eax
801040d2:	73 1c                	jae    801040f0 <kill+0x40>
    if(p->pid == pid){
801040d4:	39 50 10             	cmp    %edx,0x10(%eax)
801040d7:	75 ef                	jne    801040c8 <kill+0x18>
      p->pending_signals = p->pending_signals | 1<<signum;
801040d9:	ba 01 00 00 00       	mov    $0x1,%edx
801040de:	d3 e2                	shl    %cl,%edx
801040e0:	09 50 7c             	or     %edx,0x7c(%eax)
      return 0;
...
80104104:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104107:	e8 34 05 00 00       	call   80104640 <pushcli>
  c = mycpu();
8010410c:	e8 9f f5 ff ff       	call   801036b0 <mycpu>
  p = c->proc;
80104111:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104117:	e8 64 05 00 00       	call   80104680 <popcli>
  p->killed = 1;
8010411c:	c7 43 24 01 00 00 00 	movl   $0x1,0x24(%ebx)
}
...
8010414b:	68 e3 7c 10 80       	push   $0x80107ce3
80104150:	e8 0b c5 ff ff       	call   80100660 <cprintf>
80104155:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104158:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
8010415e:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
...
80104171:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104174:	ba 60 79 10 80       	mov    $0x80107960,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104179:	77 11                	ja     8010418c <procdump+0x5c>
8010417b:	8b 14 85 c0 79 10 80 	mov    -0x7fef8640(,%eax,4),%edx
      state = "???";
80104182:	b8 60 79 10 80       	mov    $0x80107960,%eax
...
80104194:	68 64 79 10 80       	push   $0x80107964
...
801041bb:	e8 30 04 00 00       	call   801045f0 <getcallerpcs>
...
801041d9:	68 a1 73 10 80       	push   $0x801073a1
...
80104204:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104207:	e8 34 04 00 00       	call   80104640 <pushcli>
  c = mycpu();
8010420c:	e8 9f f4 ff ff       	call   801036b0 <mycpu>
  p = c->proc;
80104211:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104217:	e8 64 04 00 00       	call   80104680 <popcli>
  p->signal_mask = sigmask;
8010421c:	8b 55 08             	mov    0x8(%ebp),%edx
  uint oldmask = p->signal_mask;
8010421f:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
  p->signal_mask = sigmask;
80104225:	89 93 80 00 00 00    	mov    %edx,0x80(%ebx)
}
8010422b:	83 c4 04             	add    $0x4,%esp
8010422e:	5b                   	pop    %ebx
8010422f:	5d                   	pop    %ebp
80104230:	c3                   	ret    
80104231:	eb 0d                	jmp    80104240 <sigaction>
80104233:	90                   	nop
80104234:	90                   	nop
80104235:	90                   	nop
80104236:	90                   	nop
...
8010424c:	8b 75 10             	mov    0x10(%ebp),%esi
  pushcli();
8010424f:	e8 ec 03 00 00       	call   80104640 <pushcli>
  c = mycpu();
80104254:	e8 57 f4 ff ff       	call   801036b0 <mycpu>
  p = c->proc;
80104259:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
8010425f:	e8 1c 04 00 00       	call   80104680 <popcli>
    if (signum > 31 || signum < 0 || signum == SIGSTOP || signum == SIGKILL)
80104264:	8d 43 f7             	lea    -0x9(%ebx),%eax
80104267:	83 e0 f7             	and    $0xfffffff7,%eax
8010426a:	74 34                	je     801042a0 <sigaction+0x60>
8010426c:	83 fb 1f             	cmp    $0x1f,%ebx
8010426f:	77 2f                	ja     801042a0 <sigaction+0x60>
    if (oldact != null){
80104271:	85 f6                	test   %esi,%esi
80104273:	8d 4b 20             	lea    0x20(%ebx),%ecx
80104276:	74 0e                	je     80104286 <sigaction+0x46>
      *oldact = *(struct sigaction *)(p->signal_handlers[signum]);
80104278:	8b 44 8f 04          	mov    0x4(%edi,%ecx,4),%eax
8010427c:	8b 50 04             	mov    0x4(%eax),%edx
8010427f:	8b 00                	mov    (%eax),%eax
80104281:	89 56 04             	mov    %edx,0x4(%esi)
80104284:	89 06                	mov    %eax,(%esi)
    p->signal_handlers[signum] = (struct sigaction *)act;
80104286:	8b 45 0c             	mov    0xc(%ebp),%eax
80104289:	89 44 8f 04          	mov    %eax,0x4(%edi,%ecx,4)
    return 0;
8010428d:	31 c0                	xor    %eax,%eax
}
8010428f:	83 c4 0c             	add    $0xc,%esp
80104292:	5b                   	pop    %ebx
80104293:	5e                   	pop    %esi
80104294:	5f                   	pop    %edi
80104295:	5d                   	pop    %ebp
...
801042a5:	eb e8                	jmp    8010428f <sigaction+0x4f>
...
801042b6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
801042b9:	e8 82 03 00 00       	call   80104640 <pushcli>
  c = mycpu();
801042be:	e8 ed f3 ff ff       	call   801036b0 <mycpu>
  p = c->proc;
801042c3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801042c9:	e8 b2 03 00 00       	call   80104680 <popcli>
  *p->tf = *p->backup; 
801042ce:	b9 13 00 00 00       	mov    $0x13,%ecx
801042d3:	8b 43 18             	mov    0x18(%ebx),%eax
801042d6:	8b b3 04 01 00 00    	mov    0x104(%ebx),%esi
801042dc:	89 c7                	mov    %eax,%edi
801042de:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
}
801042e0:	83 c4 0c             	add    $0xc,%esp
801042e3:	5b                   	pop    %ebx
801042e4:	5e                   	pop    %esi
801042e5:	5f                   	pop    %edi
801042e6:	5d                   	pop    %ebp
...
801042f4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801042f7:	e8 44 03 00 00       	call   80104640 <pushcli>
  c = mycpu();
801042fc:	e8 af f3 ff ff       	call   801036b0 <mycpu>
  p = c->proc;
80104301:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104307:	e8 74 03 00 00       	call   80104680 <popcli>
  p->suspended = 1; 
8010430c:	c7 83 08 01 00 00 01 	movl   $0x1,0x108(%ebx)
80104313:	00 00 00 
}
...
80104324:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104327:	e8 14 03 00 00       	call   80104640 <pushcli>
  c = mycpu();
8010432c:	e8 7f f3 ff ff       	call   801036b0 <mycpu>
  p = c->proc;
80104331:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104337:	e8 44 03 00 00       	call   80104680 <popcli>
  if (p-> suspended == 1)
8010433c:	83 bb 08 01 00 00 01 	cmpl   $0x1,0x108(%ebx)
80104343:	75 0a                	jne    8010434f <cont_handler+0x2f>
    p->suspended = 0; 
80104345:	c7 83 08 01 00 00 00 	movl   $0x0,0x108(%ebx)
8010434c:	00 00 00 
}
...
80104366:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80104369:	e8 d2 02 00 00       	call   80104640 <pushcli>
  c = mycpu();
8010436e:	e8 3d f3 ff ff       	call   801036b0 <mycpu>
  p = c->proc;
80104373:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104379:	e8 02 03 00 00       	call   80104680 <popcli>
            stop_handler();
          else
            kill_handler();
        }
...
8010437e:	b8 60 43 10 80       	mov    $0x80104360,%eax
  for(int i=0; i<32; i=i+1){
80104383:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  int signal_index = 1;
8010438a:	ba 01 00 00 00       	mov    $0x1,%edx
          int functionSize = ((int)check_for_signals - (int)call_sigret); 
8010438f:	2d 30 36 10 80       	sub    $0x80103630,%eax
80104394:	89 45 dc             	mov    %eax,-0x24(%ebp)
...
801043a0:	8b 8b 80 00 00 00    	mov    0x80(%ebx),%ecx
    if(((p->pending_signals & signal_index) == signal_index) & (is_blocked == 0)){
801043a6:	8b 43 7c             	mov    0x7c(%ebx),%eax
    is_blocked = (p->signal_mask & signal_index) == signal_index; //check if signal is blocked 
801043a9:	21 d1                	and    %edx,%ecx
    if(((p->pending_signals & signal_index) == signal_index) & (is_blocked == 0)){
801043ab:	39 d1                	cmp    %edx,%ecx
801043ad:	0f 84 99 00 00 00    	je     8010444c <check_for_signals+0xec>
801043b3:	89 d1                	mov    %edx,%ecx
801043b5:	21 c1                	and    %eax,%ecx
801043b7:	39 d1                	cmp    %edx,%ecx
801043b9:	0f 85 8d 00 00 00    	jne    8010444c <check_for_signals+0xec>
      p->pending_signals = p->pending_signals & (~signal_index); //discard signal
801043bf:	89 d1                	mov    %edx,%ecx
      if((int)p->signal_handlers[i] != SIG_IGN){
801043c1:	8b 7d e4             	mov    -0x1c(%ebp),%edi
      p->pending_signals = p->pending_signals & (~signal_index); //discard signal
801043c4:	f7 d1                	not    %ecx
801043c6:	21 c8                	and    %ecx,%eax
801043c8:	89 43 7c             	mov    %eax,0x7c(%ebx)
      if((int)p->signal_handlers[i] != SIG_IGN){
801043cb:	8b 84 bb 84 00 00 00 	mov    0x84(%ebx,%edi,4),%eax
801043d2:	83 f8 01             	cmp    $0x1,%eax
801043d5:	74 73                	je     8010444a <check_for_signals+0xea>
        if ((int)p->signal_handlers[i] == SIG_DFL){
801043d7:	85 c0                	test   %eax,%eax
801043d9:	0f 84 89 00 00 00    	je     80104468 <check_for_signals+0x108>
          //backup trapframe 
          *p->backup = *p->tf;
801043df:	8b 73 18             	mov    0x18(%ebx),%esi
801043e2:	8b bb 04 01 00 00    	mov    0x104(%ebx),%edi
801043e8:	b9 13 00 00 00       	mov    $0x13,%ecx
801043ed:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

          //put functionn
          p->tf->esp -= functionSize;
801043ef:	8b 75 dc             	mov    -0x24(%ebp),%esi
          memmove((int*)p->tf->esp, &call_sigret, functionSize);
801043f2:	83 ec 04             	sub    $0x4,%esp
801043f5:	89 55 e0             	mov    %edx,-0x20(%ebp)
          p->tf->esp -= functionSize;
801043f8:	8b 43 18             	mov    0x18(%ebx),%eax
801043fb:	29 70 44             	sub    %esi,0x44(%eax)
          memmove((int*)p->tf->esp, &call_sigret, functionSize);
801043fe:	56                   	push   %esi
801043ff:	68 30 36 10 80       	push   $0x80103630
80104404:	8b 43 18             	mov    0x18(%ebx),%eax
80104407:	ff 70 44             	pushl  0x44(%eax)
8010440a:	e8 c1 04 00 00       	call   801048d0 <memmove>
          uint returnAdress = p->tf->esp;
8010440f:	8b 4b 18             	mov    0x18(%ebx),%ecx
          *(int*)p->tf->esp = i;
          //push return address
          p->tf->esp -= sizeof(int);
...
80104415:	83 c4 10             	add    $0x10,%esp
          uint returnAdress = p->tf->esp;
80104418:	8b 41 44             	mov    0x44(%ecx),%eax
          p->tf->esp -= sizeof i;
8010441b:	8d 70 fc             	lea    -0x4(%eax),%esi
8010441e:	89 71 44             	mov    %esi,0x44(%ecx)
          *(int*)p->tf->esp = i;
80104421:	8b 4b 18             	mov    0x18(%ebx),%ecx
80104424:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80104427:	8b 49 44             	mov    0x44(%ecx),%ecx
8010442a:	89 31                	mov    %esi,(%ecx)
          p->tf->esp -= sizeof(int);
8010442c:	8b 4b 18             	mov    0x18(%ebx),%ecx
8010442f:	83 69 44 04          	subl   $0x4,0x44(%ecx)
          *(int*)p->tf->esp = returnAdress; //adrees to the function that calls sigret 
80104433:	8b 4b 18             	mov    0x18(%ebx),%ecx
80104436:	8b 49 44             	mov    0x44(%ecx),%ecx
80104439:	89 01                	mov    %eax,(%ecx)
          p->tf->eip = (uint)handler-> sa_handler; 
8010443b:	8b 8c b3 84 00 00 00 	mov    0x84(%ebx,%esi,4),%ecx
80104442:	8b 43 18             	mov    0x18(%ebx),%eax
80104445:	8b 09                	mov    (%ecx),%ecx
80104447:	89 48 38             	mov    %ecx,0x38(%eax)

        }
    }
    signal_index = signal_index<<1; 
8010444a:	01 d2                	add    %edx,%edx
  for(int i=0; i<32; i=i+1){
8010444c:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80104450:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104453:	83 f8 20             	cmp    $0x20,%eax
80104456:	0f 85 44 ff ff ff    	jne    801043a0 <check_for_signals+0x40>
    }
  }
}
...
80104464:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
          if(i == SIGCONT)
80104468:	83 ff 13             	cmp    $0x13,%edi
8010446b:	74 1d                	je     8010448a <check_for_signals+0x12a>
          else if(i==SIGSTOP)
8010446d:	83 7d e4 11          	cmpl   $0x11,-0x1c(%ebp)
80104471:	89 55 e0             	mov    %edx,-0x20(%ebp)
80104474:	74 0a                	je     80104480 <check_for_signals+0x120>
            kill_handler();
80104476:	e8 85 fc ff ff       	call   80104100 <kill_handler>
8010447b:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010447e:	eb ca                	jmp    8010444a <check_for_signals+0xea>
            stop_handler();
80104480:	e8 6b fe ff ff       	call   801042f0 <stop_handler>
80104485:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104488:	eb c0                	jmp    8010444a <check_for_signals+0xea>
8010448a:	89 55 e0             	mov    %edx,-0x20(%ebp)
            cont_handler();
8010448d:	e8 8e fe ff ff       	call   80104320 <cont_handler>
80104492:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104495:	eb b3                	jmp    8010444a <check_for_signals+0xea>
...
80104505:	e8 86 f9 ff ff       	call   80103e90 <sleep>
  while (lk->locked) {
...
80104513:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104519:	e8 32 f2 ff ff       	call   80103750 <myproc>
...
80104564:	e8 e7 fa ff ff       	call   80104050 <wakeup>
  release(&lk->lk);
...
801045a3:	e8 a8 f1 ff ff       	call   80103750 <myproc>
...
80104649:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010464a:	e8 61 f0 ff ff       	call   801036b0 <mycpu>
...
80104664:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010466a:	e8 41 f0 ff ff       	call   801036b0 <mycpu>
...
801046ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801046b0:	e8 fb ef ff ff       	call   801036b0 <mycpu>
...
801046f8:	e8 b3 ef ff ff       	call   801036b0 <mycpu>
...
80104754:	e8 57 ef ff ff       	call   801036b0 <mycpu>
...
80104a77:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104a7a:	e8 d1 ec ff ff       	call   80103750 <myproc>
...
80104ab7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104aba:	e8 91 ec ff ff       	call   80103750 <myproc>
...
80104b25:	e8 26 ec ff ff       	call   80103750 <myproc>
...
80104b33:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b36:	e8 15 ec ff ff       	call   80103750 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104b78:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104b7b:	e8 d0 eb ff ff       	call   80103750 <myproc>
...
80104c14:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104c17:	e8 34 eb ff ff       	call   80103750 <myproc>
...
80104e34:	e8 17 e9 ff ff       	call   80103750 <myproc>
...
801053ff:	0f 84 a6 00 00 00    	je     801054ab <sys_open+0x12b>
  struct proc *curproc = myproc();
80105405:	e8 46 e3 ff ff       	call   80103750 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801055d5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801055d8:	e8 73 e1 ff ff       	call   80103750 <myproc>
...
801057af:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801057b1:	e8 9a df ff ff       	call   80103750 <myproc>
...
801057d7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801057da:	e8 71 df ff ff       	call   80103750 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105863:	83 ec 08             	sub    $0x8,%esp
  exit();
80105866:	e8 a5 e4 ff ff       	call   80103d10 <exit>
...
80105873:	5d                   	pop    %ebp
  return wait();
80105874:	e9 d7 e6 ff ff       	jmp    80103f50 <wait>
...
801058b6:	e8 f5 e7 ff ff       	call   801040b0 <kill>
...
801058d3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801058d6:	e8 75 de ff ff       	call   80103750 <myproc>
...
801058f7:	78 27                	js     80105920 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801058f9:	e8 52 de ff ff       	call   80103750 <myproc>
  if(growproc(n) < 0)
...
8010597d:	e8 0e e5 ff ff       	call   80103e90 <sleep>
  while(ticks - ticks0 < n){
...
8010598f:	73 2f                	jae    801059c0 <sys_sleep+0x90>
    if(myproc()->killed){
80105991:	e8 ba dd ff ff       	call   80103750 <myproc>
...
80105a2e:	e8 cd e7 ff ff       	call   80104200 <sigprocmask>
...
80105aa2:	e8 99 e7 ff ff       	call   80104240 <sigaction>
...
80105bd0:	e8 7b db ff ff       	call   80103750 <myproc>
...
80105bf0:	e8 3b db ff ff       	call   80103730 <cpuid>
...
80105c01:	e8 4a db ff ff       	call   80103750 <myproc>
80105c06:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105c09:	e8 42 db ff ff       	call   80103750 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105c32:	e8 19 db ff ff       	call   80103750 <myproc>
...
80105c3e:	e8 0d db ff ff       	call   80103750 <myproc>
80105c43:	85 c0                	test   %eax,%eax
80105c45:	74 1d                	je     80105c64 <trap+0xc4>
80105c47:	e8 04 db ff ff       	call   80103750 <myproc>
...
80105c64:	e8 e7 da ff ff       	call   80103750 <myproc>
80105c69:	85 c0                	test   %eax,%eax
80105c6b:	74 0b                	je     80105c78 <trap+0xd8>
80105c6d:	e8 de da ff ff       	call   80103750 <myproc>
...
80105c76:	74 68                	je     80105ce0 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c78:	e8 d3 da ff ff       	call   80103750 <myproc>
80105c7d:	85 c0                	test   %eax,%eax
80105c7f:	74 19                	je     80105c9a <trap+0xfa>
80105c81:	e8 ca da ff ff       	call   80103750 <myproc>
...
80105ca2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105ca8:	e8 a3 da ff ff       	call   80103750 <myproc>
...
80105cc0:	e8 4b ef ff ff       	call   80104c10 <syscall>
    if(myproc()->killed)
80105cc5:	e8 86 da ff ff       	call   80103750 <myproc>
...
80105cfd:	e8 7e ca ff ff       	call   80102780 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d02:	e8 49 da ff ff       	call   80103750 <myproc>
...
80105d1d:	e8 5e ca ff ff       	call   80102780 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d22:	e8 29 da ff ff       	call   80103750 <myproc>
...
80105d3d:	e8 3e ca ff ff       	call   80102780 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d42:	e8 09 da ff ff       	call   80103750 <myproc>
...
80105d5f:	e8 cc d9 ff ff       	call   80103730 <cpuid>
...
80105d76:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d79:	e8 d2 d9 ff ff       	call   80103750 <myproc>
...
80105dd4:	83 05 a0 78 11 80 01 	addl   $0x1,0x801178a0
      wakeup(&ticks);
80105ddb:	e8 70 e2 ff ff       	call   80104050 <wakeup>
      release(&tickslock);
...
80105df4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105df7:	e8 34 d9 ff ff       	call   80103730 <cpuid>
...
80106bd3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106bd6:	e8 55 cb ff ff       	call   80103730 <cpuid>
...
80106caf:	e8 fc c9 ff ff       	call   801036b0 <mycpu>
80106cb4:	89 c6                	mov    %eax,%esi
80106cb6:	e8 f5 c9 ff ff       	call   801036b0 <mycpu>
80106cbb:	89 c7                	mov    %eax,%edi
80106cbd:	e8 ee c9 ff ff       	call   801036b0 <mycpu>
80106cc2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106cc5:	83 c7 08             	add    $0x8,%edi
80106cc8:	e8 e3 c9 ff ff       	call   801036b0 <mycpu>
