...
80101265:	e8 46 32 00 00       	call   801044b0 <memset>
  log_write(bp);
...
801012aa:	e8 f1 30 00 00       	call   801043a0 <acquire>
...
8010130f:	e8 4c 31 00 00       	call   80104460 <release>
...
8010133a:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
8010133d:	e8 1e 31 00 00       	call   80104460 <release>
      return ip;
...
801014af:	e8 7c 2c 00 00       	call   80104130 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010165f:	e8 3c 2d 00 00       	call   801043a0 <acquire>
  ip->ref++;
...
801016a2:	e8 c9 2a 00 00       	call   80104170 <acquiresleep>
  if(ip->valid == 0){
...
80101773:	e8 98 2a 00 00       	call   80104210 <holdingsleep>
...
8010178e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010178f:	e9 3c 2a 00 00       	jmp    801041d0 <releasesleep>
    panic("iunlock");
...
801017c0:	e8 ab 29 00 00       	call   80104170 <acquiresleep>
...
801017da:	e8 f1 29 00 00       	call   801041d0 <releasesleep>
  acquire(&icache.lock);
801017df:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017e6:	e8 b5 2b 00 00       	call   801043a0 <acquire>
  ip->ref--;
...
801017ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101800:	e9 5b 2c 00 00       	jmp    80104460 <release>
80101805:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101808:	83 ec 0c             	sub    $0xc,%esp
8010180b:	68 e0 09 11 80       	push   $0x801109e0
80101810:	e8 8b 2b 00 00       	call   801043a0 <acquire>
    int r = ip->ref;
80101815:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101818:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010181f:	e8 3c 2c 00 00       	call   80104460 <release>
    if(r == 1){
...
80101a05:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a07:	e8 54 2b 00 00       	call   80104560 <memmove>
    brelse(bp);
...
80101b03:	e8 58 2a 00 00       	call   80104560 <memmove>
    log_write(bp);
...
80101b9e:	e8 2d 2a 00 00       	call   801045d0 <strncmp>
}
80101ba3:	c9                   	leave  
80101ba4:	c3                   	ret    
...
80101bfd:	e8 ce 29 00 00       	call   801045d0 <strncmp>
      continue;
...
80101c89:	e8 12 27 00 00       	call   801043a0 <acquire>
  ip->ref++;
80101c8e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c92:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101c99:	e8 c2 27 00 00       	call   80104460 <release>
...
80101cf5:	e8 66 28 00 00       	call   80104560 <memmove>
    path++;
...
80101d88:	e8 d3 27 00 00       	call   80104560 <memmove>
    name[len] = 0;
...
80101e7d:	e8 ae 27 00 00       	call   80104630 <strncpy>
  de.inum = inum;
...
80101ec8:	68 7e 76 10 80       	push   $0x8010767e
...
8010208e:	e8 0d 23 00 00       	call   801043a0 <acquire>
...
8010210f:	e8 4c 23 00 00       	call   80104460 <release>
...
8010212e:	e8 dd 20 00 00       	call   80104210 <holdingsleep>
...
80102168:	e8 33 22 00 00       	call   801043a0 <acquire>
...
801021d5:	c9                   	leave  
  release(&idelock);
801021d6:	e9 85 22 00 00       	jmp    80104460 <release>
801021db:	90                   	nop
...
80102322:	81 fb a8 77 11 80    	cmp    $0x801177a8,%ebx
...
80102342:	e8 69 21 00 00       	call   801044b0 <memset>
...
8010237a:	c9                   	leave  
    release(&kmem.lock);
8010237b:	e9 e0 20 00 00       	jmp    80104460 <release>
    acquire(&kmem.lock);
80102380:	83 ec 0c             	sub    $0xc,%esp
80102383:	68 40 26 11 80       	push   $0x80112640
80102388:	e8 13 20 00 00       	call   801043a0 <acquire>
...
801024f3:	e8 a8 1e 00 00       	call   801043a0 <acquire>
  r = kmem.freelist;
...
80102521:	e8 3a 1f 00 00       	call   80104460 <release>
  return (char*)r;
...
80102937:	e8 c4 1b 00 00       	call   80104500 <memcmp>
...
80102a64:	e8 f7 1a 00 00       	call   80104560 <memmove>
...
80102bab:	e8 f0 17 00 00       	call   801043a0 <acquire>
...
80102bfc:	e8 5f 18 00 00       	call   80104460 <release>
      break;
    }
  }
}
...
80102c1e:	e8 7d 17 00 00       	call   801043a0 <acquire>
  log.outstanding -= 1;
...
80102cb6:	e8 a5 18 00 00       	call   80104560 <memmove>
...
80102cff:	e8 9c 16 00 00       	call   801043a0 <acquire>
    wakeup(&log);
...
80102d21:	e8 3a 17 00 00       	call   80104460 <release>
...
80102d4c:	e8 0f 17 00 00       	call   80104460 <release>
...
80102dae:	e8 ed 15 00 00       	call   801043a0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dfc:	c9                   	leave  
  release(&log.lock);
80102dfd:	e9 5e 16 00 00       	jmp    80104460 <release>
...
80102eb7:	68 a8 77 11 80       	push   $0x801177a8
...
80102f14:	e8 47 16 00 00       	call   80104560 <memmove>
...
80102ff4:	e8 07 15 00 00       	call   80104500 <memcmp>
...
801030b2:	e8 49 14 00 00       	call   80104500 <memcmp>
...
8010360b:	e8 50 0e 00 00       	call   80104460 <release>
...
80103656:	68 75 74 10 80       	push   $0x80107475
8010365b:	68 20 2d 11 80       	push   $0x80112d20
80103660:	e8 fb 0b 00 00       	call   80104260 <initlock>
}
...
80103714:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103717:	e8 b4 0b 00 00       	call   801042d0 <pushcli>
  c = mycpu();
8010371c:	e8 4f ff ff ff       	call   80103670 <mycpu>
  p = c->proc;
80103721:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103727:	e8 e4 0b 00 00       	call   80104310 <popcli>
}
...
8010374c:	e8 4f 0c 00 00       	call   801043a0 <acquire>
  pid = nextpid++;
...
80103761:	a3 04 a0 10 80       	mov    %eax,0x8010a004
  release(&ptable.lock);
80103766:	e8 f5 0c 00 00       	call   80104460 <release>
}
...
80103791:	e8 0a 0c 00 00       	call   801043a0 <acquire>
80103796:	83 c4 10             	add    $0x10,%esp
80103799:	eb 13                	jmp    801037ae <allocproc+0x2e>
8010379b:	90                   	nop
8010379c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037a0:	81 c3 08 01 00 00    	add    $0x108,%ebx
801037a6:	81 fb 54 6f 11 80    	cmp    $0x80116f54,%ebx
801037ac:	73 72                	jae    80103820 <allocproc+0xa0>
    if(p->state == UNUSED)
...
801037b5:	83 ec 0c             	sub    $0xc,%esp
  p->state = EMBRYO;
801037b8:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  release(&ptable.lock);
801037bf:	68 20 2d 11 80       	push   $0x80112d20
801037c4:	e8 97 0c 00 00       	call   80104460 <release>
  p->pid = allocpid();
801037c9:	e8 72 ff ff ff       	call   80103740 <allocpid>
801037ce:	89 43 10             	mov    %eax,0x10(%ebx)
  if((p->kstack = kalloc()) == 0){
801037d1:	e8 ea ec ff ff       	call   801024c0 <kalloc>
801037d6:	83 c4 10             	add    $0x10,%esp
801037d9:	85 c0                	test   %eax,%eax
801037db:	89 43 08             	mov    %eax,0x8(%ebx)
801037de:	74 59                	je     80103839 <allocproc+0xb9>
  sp -= sizeof *p->tf;
801037e0:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  memset(p->context, 0, sizeof *p->context);
801037e6:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
801037e9:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
801037ee:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
801037f1:	c7 40 14 a2 56 10 80 	movl   $0x801056a2,0x14(%eax)
  p->context = (struct context*)sp;
801037f8:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
801037fb:	6a 14                	push   $0x14
801037fd:	6a 00                	push   $0x0
801037ff:	50                   	push   %eax
80103800:	e8 ab 0c 00 00       	call   801044b0 <memset>
  p->context->eip = (uint)forkret;
80103805:	8b 43 1c             	mov    0x1c(%ebx),%eax
  return p;
80103808:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
8010380b:	c7 40 10 00 36 10 80 	movl   $0x80103600,0x10(%eax)
}
...
8010382a:	e8 31 0c 00 00       	call   80104460 <release>
}
...
80103842:	eb ce                	jmp    80103812 <allocproc+0x92>
...
80103863:	e8 08 34 00 00       	call   80106c70 <setupkvm>
...
80103881:	e8 ca 30 00 00       	call   80106950 <inituvm>
...
80103896:	e8 15 0c 00 00       	call   801044b0 <memset>
...
801038f5:	e8 96 0d 00 00       	call   80104690 <safestrcpy>
  p->cwd = namei("/");
...
80103945:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103948:	e8 83 09 00 00       	call   801042d0 <pushcli>
  c = mycpu();
8010394d:	e8 1e fd ff ff       	call   80103670 <mycpu>
  p = c->proc;
80103952:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103958:	e8 b3 09 00 00       	call   80104310 <popcli>
  if(n > 0){
...
8010396c:	e8 cf 2e 00 00       	call   80106840 <switchuvm>
  return 0;
...
8010398a:	e8 01 31 00 00       	call   80106a90 <allocuvm>
...
801039aa:	e8 11 32 00 00       	call   80106bc0 <deallocuvm>
...
801039c6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801039c9:	e8 02 09 00 00       	call   801042d0 <pushcli>
  c = mycpu();
801039ce:	e8 9d fc ff ff       	call   80103670 <mycpu>
  p = c->proc;
801039d3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039d9:	e8 32 09 00 00       	call   80104310 <popcli>
  if((np = allocproc()) == 0){
...
801039f8:	e8 43 33 00 00       	call   80106d40 <copyuvm>
...
80103b0e:	e8 8d 08 00 00       	call   801043a0 <acquire>
...
80103b30:	e8 0b 2d 00 00       	call   80106840 <switchuvm>
...
80103b3b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b42:	e8 a4 0b 00 00       	call   801046eb <swtch>
      switchkvm();
80103b47:	e8 d4 2c 00 00       	call   80106820 <switchkvm>
      c->proc = 0;
80103b4c:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103b53:	00 00 00 
80103b56:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b59:	81 c3 08 01 00 00    	add    $0x108,%ebx
80103b5f:	81 fb 54 6f 11 80    	cmp    $0x80116f54,%ebx
80103b65:	72 b9                	jb     80103b20 <scheduler+0x40>
    release(&ptable.lock);
80103b67:	83 ec 0c             	sub    $0xc,%esp
80103b6a:	68 20 2d 11 80       	push   $0x80112d20
80103b6f:	e8 ec 08 00 00       	call   80104460 <release>
    sti();
...
80103be3:	e8 03 0b 00 00       	call   801046eb <swtch>
  mycpu()->intena = intena;
...
80103c46:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c49:	e8 82 06 00 00       	call   801042d0 <pushcli>
  c = mycpu();
80103c4e:	e8 1d fa ff ff       	call   80103670 <mycpu>
  p = c->proc;
80103c53:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c59:	e8 b2 06 00 00       	call   80104310 <popcli>
  if(curproc == initproc)
...
80103cb2:	e8 e9 06 00 00       	call   801043a0 <acquire>
...
80103cc8:	05 08 01 00 00       	add    $0x108,%eax
80103ccd:	3d 54 6f 11 80       	cmp    $0x80116f54,%eax
...
80103cdf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ce6:	05 08 01 00 00       	add    $0x108,%eax
80103ceb:	3d 54 6f 11 80       	cmp    $0x80116f54,%eax
...
80103cff:	90                   	nop
80103d00:	81 c2 08 01 00 00    	add    $0x108,%edx
80103d06:	81 fa 54 6f 11 80    	cmp    $0x80116f54,%edx
...
80103d28:	05 08 01 00 00       	add    $0x108,%eax
80103d2d:	3d 54 6f 11 80       	cmp    $0x80116f54,%eax
...
80103d57:	68 fd 74 10 80       	push   $0x801074fd
80103d5c:	e8 2f c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d61:	83 ec 0c             	sub    $0xc,%esp
80103d64:	68 f0 74 10 80       	push   $0x801074f0
...
80103d7c:	e8 1f 06 00 00       	call   801043a0 <acquire>
  pushcli();
80103d81:	e8 4a 05 00 00       	call   801042d0 <pushcli>
  c = mycpu();
80103d86:	e8 e5 f8 ff ff       	call   80103670 <mycpu>
  p = c->proc;
80103d8b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d91:	e8 7a 05 00 00       	call   80104310 <popcli>
...
80103da9:	e8 b2 06 00 00       	call   80104460 <release>
}
...
80103dcc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103dcf:	e8 fc 04 00 00       	call   801042d0 <pushcli>
  c = mycpu();
80103dd4:	e8 97 f8 ff ff       	call   80103670 <mycpu>
  p = c->proc;
80103dd9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ddf:	e8 2c 05 00 00       	call   80104310 <popcli>
  if(p == 0)
...
80103e00:	e8 9b 05 00 00       	call   801043a0 <acquire>
    release(lk);
80103e05:	89 34 24             	mov    %esi,(%esp)
80103e08:	e8 53 06 00 00       	call   80104460 <release>
  p->chan = chan;
...
80103e2a:	e8 31 06 00 00       	call   80104460 <release>
    acquire(lk);
...
80103e3b:	5d                   	pop    %ebp
    acquire(lk);
80103e3c:	e9 5f 05 00 00       	jmp    801043a0 <acquire>
...
80103e69:	68 0f 75 10 80       	push   $0x8010750f
80103e6e:	e8 1d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e73:	83 ec 0c             	sub    $0xc,%esp
80103e76:	68 09 75 10 80       	push   $0x80107509
...
80103eb8:	81 c3 08 01 00 00    	add    $0x108,%ebx
80103ebe:	81 fb 54 6f 11 80    	cmp    $0x80116f54,%ebx
...
80103ecf:	74 37                	je     80103f08 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ed1:	81 c3 08 01 00 00    	add    $0x108,%ebx
      havekids = 1;
80103ed7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103edc:	81 fb 54 6f 11 80    	cmp    $0x80116f54,%ebx
...
80103f1a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f21:	e8 ca 2c 00 00       	call   80106bf0 <freevm>
        release(&ptable.lock);
...
80103f46:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f4d:	e8 0e 05 00 00       	call   80104460 <release>
        return pid;
...
80103f6b:	e8 f0 04 00 00       	call   80104460 <release>
      return -1;
...
80103f8f:	e8 0c 04 00 00       	call   801043a0 <acquire>
...
80103fa5:	3d 54 6f 11 80       	cmp    $0x80116f54,%eax
...
80103fb7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fbe:	05 08 01 00 00       	add    $0x108,%eax
80103fc3:	3d 54 6f 11 80       	cmp    $0x80116f54,%eax
...
80103fd4:	c9                   	leave  
  release(&ptable.lock);
80103fd5:	e9 86 04 00 00       	jmp    80104460 <release>
...
80103fef:	e8 ac 03 00 00       	call   801043a0 <acquire>
...
80104000:	05 08 01 00 00       	add    $0x108,%eax
80104005:	3d 54 6f 11 80       	cmp    $0x80116f54,%eax
...
8010402d:	e8 2e 04 00 00       	call   80104460 <release>
      return 0;
...
80104048:	e8 13 04 00 00       	call   80104460 <release>
  return -1;
...
8010407b:	68 97 78 10 80       	push   $0x80107897
80104080:	e8 db c5 ff ff       	call   80100660 <cprintf>
80104085:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104088:	81 c3 08 01 00 00    	add    $0x108,%ebx
8010408e:	81 fb 54 6f 11 80    	cmp    $0x80116f54,%ebx
...
801040a1:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801040a4:	ba 20 75 10 80       	mov    $0x80107520,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040a9:	77 11                	ja     801040bc <procdump+0x5c>
801040ab:	8b 14 85 80 75 10 80 	mov    -0x7fef8a80(,%eax,4),%edx
      state = "???";
801040b2:	b8 20 75 10 80       	mov    $0x80107520,%eax
...
801040c4:	68 24 75 10 80       	push   $0x80107524
...
80104109:	68 61 6f 10 80       	push   $0x80106f61
...
8010413a:	68 98 75 10 80       	push   $0x80107598
...
80104195:	e8 26 fc ff ff       	call   80103dc0 <sleep>
  while (lk->locked) {
...
801041a3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801041a9:	e8 62 f5 ff ff       	call   80103710 <myproc>
...
80104233:	e8 d8 f4 ff ff       	call   80103710 <myproc>
...
801042ef:	e8 7c f3 ff ff       	call   80103670 <mycpu>
801042f4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801042fa:	e8 71 f3 ff ff       	call   80103670 <mycpu>
...
8010433c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104340:	e8 2b f3 ff ff       	call   80103670 <mycpu>
...
80104355:	68 a3 75 10 80       	push   $0x801075a3
8010435a:	e8 31 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
8010435f:	83 ec 0c             	sub    $0xc,%esp
80104362:	68 ba 75 10 80       	push   $0x801075ba
...
80104388:	e8 e3 f2 ff ff       	call   80103670 <mycpu>
...
801043e4:	e8 87 f2 ff ff       	call   80103670 <mycpu>
...
80104447:	68 c1 75 10 80       	push   $0x801075c1
...
8010449c:	68 c9 75 10 80       	push   $0x801075c9
...
80104707:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010470a:	e8 01 f0 ff ff       	call   80103710 <myproc>
...
80104747:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010474a:	e8 c1 ef ff ff       	call   80103710 <myproc>
...
801047b5:	e8 56 ef ff ff       	call   80103710 <myproc>
...
801047c3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801047c6:	e8 45 ef ff ff       	call   80103710 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104808:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010480b:	e8 00 ef ff ff       	call   80103710 <myproc>
...
801048a4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801048a7:	e8 64 ee ff ff       	call   80103710 <myproc>
...
801048b7:	83 fa 14             	cmp    $0x14,%edx
801048ba:	77 1c                	ja     801048d8 <syscall+0x38>
801048bc:	8b 14 85 00 76 10 80 	mov    -0x7fef8a00(,%eax,4),%edx
...
801048e0:	68 d1 75 10 80       	push   $0x801075d1
...
8010493c:	e8 6f d2 ff ff       	call   80101bb0 <dirlookup>
...
8010494e:	e8 bd cf ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80104953:	89 3c 24             	mov    %edi,(%esp)
80104956:	e8 25 cd ff ff       	call   80101680 <ilock>
...
80104a65:	68 67 76 10 80       	push   $0x80107667
...
80104a7a:	68 76 76 10 80       	push   $0x80107676
80104a7f:	e8 0c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a84:	83 ec 0c             	sub    $0xc,%esp
80104a87:	68 58 76 10 80       	push   $0x80107658
...
80104ac4:	e8 47 ec ff ff       	call   80103710 <myproc>
...
80104b09:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104b0b:	e8 00 ec ff ff       	call   80103710 <myproc>
...
80104c53:	78 2b                	js     80104c80 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104c55:	e8 b6 ea ff ff       	call   80103710 <myproc>
...
80104e79:	58                   	pop    %eax
80104e7a:	5a                   	pop    %edx
80104e7b:	68 74 76 10 80       	push   $0x80107674
...
80104e94:	68 73 76 10 80       	push   $0x80107673
...
8010508f:	0f 84 a6 00 00 00    	je     8010513b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105095:	e8 76 e6 ff ff       	call   80103710 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105265:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105268:	e8 a3 e4 ff ff       	call   80103710 <myproc>
...
8010543f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105441:	e8 ca e2 ff ff       	call   80103710 <myproc>
...
80105467:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010546a:	e8 a1 e2 ff ff       	call   80103710 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801054a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
801054a8:	e8 63 e2 ff ff       	call   80103710 <myproc>
...
80105503:	5d                   	pop    %ebp
  return wait();
80105504:	e9 77 e9 ff ff       	jmp    80103e80 <wait>
...
8010552e:	e8 ad ea ff ff       	call   80103fe0 <kill>
...
80105553:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105556:	e8 b5 e1 ff ff       	call   80103710 <myproc>
...
80105577:	78 27                	js     801055a0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105579:	e8 92 e1 ff ff       	call   80103710 <myproc>
  if(growproc(n) < 0)
...
80105586:	e8 b5 e3 ff ff       	call   80103940 <growproc>
...
801055d0:	68 60 6f 11 80       	push   $0x80116f60
...
801055dd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801055e0:	8b 1d a0 77 11 80    	mov    0x801177a0,%ebx
  while(ticks - ticks0 < n){
...
801055f3:	68 60 6f 11 80       	push   $0x80116f60
801055f8:	68 a0 77 11 80       	push   $0x801177a0
801055fd:	e8 be e7 ff ff       	call   80103dc0 <sleep>
  while(ticks - ticks0 < n){
80105602:	a1 a0 77 11 80       	mov    0x801177a0,%eax
...
8010560f:	73 2f                	jae    80105640 <sys_sleep+0x90>
    if(myproc()->killed){
80105611:	e8 fa e0 ff ff       	call   80103710 <myproc>
...
80105620:	68 60 6f 11 80       	push   $0x80116f60
...
80105643:	68 60 6f 11 80       	push   $0x80116f60
...
80105664:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105667:	68 60 6f 11 80       	push   $0x80116f60
8010566c:	e8 2f ed ff ff       	call   801043a0 <acquire>
  xticks = ticks;
80105671:	8b 1d a0 77 11 80    	mov    0x801177a0,%ebx
  release(&tickslock);
80105677:	c7 04 24 60 6f 11 80 	movl   $0x80116f60,(%esp)
...
80105699:	54                   	push   %esp
  call trap
8010569a:	e8 c1 00 00 00       	call   80105760 <trap>
  addl $4, %esp
...
801056c7:	c7 04 c5 a2 6f 11 80 	movl   $0x8e000008,-0x7fee905e(,%eax,8)
801056ce:	08 00 00 8e 
801056d2:	66 89 14 c5 a0 6f 11 	mov    %dx,-0x7fee9060(,%eax,8)
801056d9:	80 
801056da:	c1 ea 10             	shr    $0x10,%edx
801056dd:	66 89 14 c5 a6 6f 11 	mov    %dx,-0x7fee905a(,%eax,8)
801056e4:	80 
  for(i = 0; i < 256; i++)
...
801056f4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056f7:	c7 05 a2 71 11 80 08 	movl   $0xef000008,0x801171a2
801056fe:	00 00 ef 
  initlock(&tickslock, "time");
80105701:	68 b9 76 10 80       	push   $0x801076b9
80105706:	68 60 6f 11 80       	push   $0x80116f60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010570b:	66 a3 a0 71 11 80    	mov    %ax,0x801171a0
80105711:	c1 e8 10             	shr    $0x10,%eax
80105714:	66 a3 a6 71 11 80    	mov    %ax,0x801171a6
  initlock(&tickslock, "time");
...
8010573b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010573f:	b8 a0 6f 11 80       	mov    $0x80116fa0,%eax
...
80105780:	ff 24 85 60 77 10 80 	jmp    *-0x7fef88a0(,%eax,4)
...
80105790:	e8 7b df ff ff       	call   80103710 <myproc>
...
801057b0:	e8 3b df ff ff       	call   801036f0 <cpuid>
...
801057c1:	e8 4a df ff ff       	call   80103710 <myproc>
801057c6:	89 45 e0             	mov    %eax,-0x20(%ebp)
801057c9:	e8 42 df ff ff       	call   80103710 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801057e5:	68 1c 77 10 80       	push   $0x8010771c
801057ea:	e8 71 ae ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801057ef:	83 c4 20             	add    $0x20,%esp
801057f2:	e8 19 df ff ff       	call   80103710 <myproc>
...
801057fe:	e8 0d df ff ff       	call   80103710 <myproc>
80105803:	85 c0                	test   %eax,%eax
80105805:	74 1d                	je     80105824 <trap+0xc4>
80105807:	e8 04 df ff ff       	call   80103710 <myproc>
...
80105824:	e8 e7 de ff ff       	call   80103710 <myproc>
80105829:	85 c0                	test   %eax,%eax
8010582b:	74 0b                	je     80105838 <trap+0xd8>
8010582d:	e8 de de ff ff       	call   80103710 <myproc>
...
80105836:	74 68                	je     801058a0 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105838:	e8 d3 de ff ff       	call   80103710 <myproc>
8010583d:	85 c0                	test   %eax,%eax
8010583f:	74 19                	je     8010585a <trap+0xfa>
80105841:	e8 ca de ff ff       	call   80103710 <myproc>
...
80105862:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105868:	e8 a3 de ff ff       	call   80103710 <myproc>
8010586d:	8b 58 24             	mov    0x24(%eax),%ebx
80105870:	85 db                	test   %ebx,%ebx
80105872:	0f 85 e8 00 00 00    	jne    80105960 <trap+0x200>
    myproc()->tf = tf;
80105878:	e8 93 de ff ff       	call   80103710 <myproc>
8010587d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105880:	e8 1b f0 ff ff       	call   801048a0 <syscall>
    if(myproc()->killed)
80105885:	e8 86 de ff ff       	call   80103710 <myproc>
...
801058fd:	e8 4e ce ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105902:	e8 09 de ff ff       	call   80103710 <myproc>
...
8010591f:	e8 cc dd ff ff       	call   801036f0 <cpuid>
80105924:	56                   	push   %esi
80105925:	53                   	push   %ebx
80105926:	50                   	push   %eax
80105927:	68 c4 76 10 80       	push   $0x801076c4
...
80105936:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105939:	e8 d2 dd ff ff       	call   80103710 <myproc>
...
8010595a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105960:	e8 db e2 ff ff       	call   80103c40 <exit>
80105965:	e9 0e ff ff ff       	jmp    80105878 <trap+0x118>
8010596a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105970:	e8 cb e2 ff ff       	call   80103c40 <exit>
80105975:	e9 aa fe ff ff       	jmp    80105824 <trap+0xc4>
8010597a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105980:	83 ec 0c             	sub    $0xc,%esp
80105983:	68 60 6f 11 80       	push   $0x80116f60
80105988:	e8 13 ea ff ff       	call   801043a0 <acquire>
      wakeup(&ticks);
8010598d:	c7 04 24 a0 77 11 80 	movl   $0x801177a0,(%esp)
      ticks++;
80105994:	83 05 a0 77 11 80 01 	addl   $0x1,0x801177a0
      wakeup(&ticks);
8010599b:	e8 e0 e5 ff ff       	call   80103f80 <wakeup>
      release(&tickslock);
801059a0:	c7 04 24 60 6f 11 80 	movl   $0x80116f60,(%esp)
...
801059b4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801059b7:	e8 34 dd ff ff       	call   801036f0 <cpuid>
...
801059c5:	68 e8 76 10 80       	push   $0x801076e8
801059ca:	e8 91 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
801059cf:	83 c4 14             	add    $0x14,%esp
801059d2:	68 be 76 10 80       	push   $0x801076be
...
80105acc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105acf:	bb e0 77 10 80       	mov    $0x801077e0,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105b67:	6a 00                	push   $0x0
  jmp alltraps
80105b69:	e9 1c fb ff ff       	jmp    8010568a <alltraps>
...
80105b70:	6a 01                	push   $0x1
  jmp alltraps
80105b72:	e9 13 fb ff ff       	jmp    8010568a <alltraps>
...
80105b79:	6a 02                	push   $0x2
  jmp alltraps
80105b7b:	e9 0a fb ff ff       	jmp    8010568a <alltraps>
...
80105b82:	6a 03                	push   $0x3
  jmp alltraps
80105b84:	e9 01 fb ff ff       	jmp    8010568a <alltraps>
...
80105b8b:	6a 04                	push   $0x4
  jmp alltraps
80105b8d:	e9 f8 fa ff ff       	jmp    8010568a <alltraps>
...
80105b94:	6a 05                	push   $0x5
  jmp alltraps
80105b96:	e9 ef fa ff ff       	jmp    8010568a <alltraps>
...
80105b9d:	6a 06                	push   $0x6
  jmp alltraps
80105b9f:	e9 e6 fa ff ff       	jmp    8010568a <alltraps>
...
80105ba6:	6a 07                	push   $0x7
  jmp alltraps
80105ba8:	e9 dd fa ff ff       	jmp    8010568a <alltraps>
...
80105bad:	6a 08                	push   $0x8
  jmp alltraps
80105baf:	e9 d6 fa ff ff       	jmp    8010568a <alltraps>
...
80105bb6:	6a 09                	push   $0x9
  jmp alltraps
80105bb8:	e9 cd fa ff ff       	jmp    8010568a <alltraps>
...
80105bbd:	6a 0a                	push   $0xa
  jmp alltraps
80105bbf:	e9 c6 fa ff ff       	jmp    8010568a <alltraps>
...
80105bc4:	6a 0b                	push   $0xb
  jmp alltraps
80105bc6:	e9 bf fa ff ff       	jmp    8010568a <alltraps>
...
80105bd2:	6a 0d                	push   $0xd
  jmp alltraps
80105bd4:	e9 b1 fa ff ff       	jmp    8010568a <alltraps>
...
80105bd9:	6a 0e                	push   $0xe
  jmp alltraps
80105bdb:	e9 aa fa ff ff       	jmp    8010568a <alltraps>
...
80105be2:	6a 0f                	push   $0xf
  jmp alltraps
80105be4:	e9 a1 fa ff ff       	jmp    8010568a <alltraps>
...
80105beb:	6a 10                	push   $0x10
  jmp alltraps
80105bed:	e9 98 fa ff ff       	jmp    8010568a <alltraps>
...
80105bf2:	6a 11                	push   $0x11
  jmp alltraps
80105bf4:	e9 91 fa ff ff       	jmp    8010568a <alltraps>
...
80105bfb:	6a 12                	push   $0x12
  jmp alltraps
80105bfd:	e9 88 fa ff ff       	jmp    8010568a <alltraps>
...
80105c0d:	6a 14                	push   $0x14
  jmp alltraps
80105c0f:	e9 76 fa ff ff       	jmp    8010568a <alltraps>
...
80105c16:	6a 15                	push   $0x15
  jmp alltraps
80105c18:	e9 6d fa ff ff       	jmp    8010568a <alltraps>
...
80105c1f:	6a 16                	push   $0x16
  jmp alltraps
80105c21:	e9 64 fa ff ff       	jmp    8010568a <alltraps>
...
80105c28:	6a 17                	push   $0x17
  jmp alltraps
80105c2a:	e9 5b fa ff ff       	jmp    8010568a <alltraps>
...
80105c31:	6a 18                	push   $0x18
  jmp alltraps
80105c33:	e9 52 fa ff ff       	jmp    8010568a <alltraps>
...
80105c3a:	6a 19                	push   $0x19
  jmp alltraps
80105c3c:	e9 49 fa ff ff       	jmp    8010568a <alltraps>
...
80105c43:	6a 1a                	push   $0x1a
  jmp alltraps
80105c45:	e9 40 fa ff ff       	jmp    8010568a <alltraps>
...
80105c4c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c4e:	e9 37 fa ff ff       	jmp    8010568a <alltraps>
...
80105c55:	6a 1c                	push   $0x1c
  jmp alltraps
80105c57:	e9 2e fa ff ff       	jmp    8010568a <alltraps>
...
80105c5e:	6a 1d                	push   $0x1d
  jmp alltraps
80105c60:	e9 25 fa ff ff       	jmp    8010568a <alltraps>
...
80105c67:	6a 1e                	push   $0x1e
  jmp alltraps
80105c69:	e9 1c fa ff ff       	jmp    8010568a <alltraps>
...
80105c70:	6a 1f                	push   $0x1f
  jmp alltraps
80105c72:	e9 13 fa ff ff       	jmp    8010568a <alltraps>
...
80105c79:	6a 20                	push   $0x20
  jmp alltraps
80105c7b:	e9 0a fa ff ff       	jmp    8010568a <alltraps>
...
80105c82:	6a 21                	push   $0x21
  jmp alltraps
80105c84:	e9 01 fa ff ff       	jmp    8010568a <alltraps>
...
80105c8b:	6a 22                	push   $0x22
  jmp alltraps
80105c8d:	e9 f8 f9 ff ff       	jmp    8010568a <alltraps>
...
80105c94:	6a 23                	push   $0x23
  jmp alltraps
80105c96:	e9 ef f9 ff ff       	jmp    8010568a <alltraps>
...
80105c9d:	6a 24                	push   $0x24
  jmp alltraps
80105c9f:	e9 e6 f9 ff ff       	jmp    8010568a <alltraps>
...
80105ca6:	6a 25                	push   $0x25
  jmp alltraps
80105ca8:	e9 dd f9 ff ff       	jmp    8010568a <alltraps>
...
80105caf:	6a 26                	push   $0x26
  jmp alltraps
80105cb1:	e9 d4 f9 ff ff       	jmp    8010568a <alltraps>
...
80105cb8:	6a 27                	push   $0x27
  jmp alltraps
80105cba:	e9 cb f9 ff ff       	jmp    8010568a <alltraps>
...
80105cc1:	6a 28                	push   $0x28
  jmp alltraps
80105cc3:	e9 c2 f9 ff ff       	jmp    8010568a <alltraps>
...
80105cca:	6a 29                	push   $0x29
  jmp alltraps
80105ccc:	e9 b9 f9 ff ff       	jmp    8010568a <alltraps>
...
80105cd3:	6a 2a                	push   $0x2a
  jmp alltraps
80105cd5:	e9 b0 f9 ff ff       	jmp    8010568a <alltraps>
...
80105cdc:	6a 2b                	push   $0x2b
  jmp alltraps
80105cde:	e9 a7 f9 ff ff       	jmp    8010568a <alltraps>
...
80105ce5:	6a 2c                	push   $0x2c
  jmp alltraps
80105ce7:	e9 9e f9 ff ff       	jmp    8010568a <alltraps>
...
80105cee:	6a 2d                	push   $0x2d
  jmp alltraps
80105cf0:	e9 95 f9 ff ff       	jmp    8010568a <alltraps>
...
80105cf7:	6a 2e                	push   $0x2e
  jmp alltraps
80105cf9:	e9 8c f9 ff ff       	jmp    8010568a <alltraps>
...
80105d00:	6a 2f                	push   $0x2f
  jmp alltraps
80105d02:	e9 83 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d09:	6a 30                	push   $0x30
  jmp alltraps
80105d0b:	e9 7a f9 ff ff       	jmp    8010568a <alltraps>
...
80105d12:	6a 31                	push   $0x31
  jmp alltraps
80105d14:	e9 71 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d1b:	6a 32                	push   $0x32
  jmp alltraps
80105d1d:	e9 68 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d24:	6a 33                	push   $0x33
  jmp alltraps
80105d26:	e9 5f f9 ff ff       	jmp    8010568a <alltraps>
...
80105d2d:	6a 34                	push   $0x34
  jmp alltraps
80105d2f:	e9 56 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d36:	6a 35                	push   $0x35
  jmp alltraps
80105d38:	e9 4d f9 ff ff       	jmp    8010568a <alltraps>
...
80105d3f:	6a 36                	push   $0x36
  jmp alltraps
80105d41:	e9 44 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d48:	6a 37                	push   $0x37
  jmp alltraps
80105d4a:	e9 3b f9 ff ff       	jmp    8010568a <alltraps>
...
80105d51:	6a 38                	push   $0x38
  jmp alltraps
80105d53:	e9 32 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d5a:	6a 39                	push   $0x39
  jmp alltraps
80105d5c:	e9 29 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d63:	6a 3a                	push   $0x3a
  jmp alltraps
80105d65:	e9 20 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d6c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d6e:	e9 17 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d75:	6a 3c                	push   $0x3c
  jmp alltraps
80105d77:	e9 0e f9 ff ff       	jmp    8010568a <alltraps>
...
80105d7e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d80:	e9 05 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d87:	6a 3e                	push   $0x3e
  jmp alltraps
80105d89:	e9 fc f8 ff ff       	jmp    8010568a <alltraps>
...
80105d90:	6a 3f                	push   $0x3f
  jmp alltraps
80105d92:	e9 f3 f8 ff ff       	jmp    8010568a <alltraps>
...
80105d99:	6a 40                	push   $0x40
  jmp alltraps
80105d9b:	e9 ea f8 ff ff       	jmp    8010568a <alltraps>
...
80105da2:	6a 41                	push   $0x41
  jmp alltraps
80105da4:	e9 e1 f8 ff ff       	jmp    8010568a <alltraps>
...
80105dab:	6a 42                	push   $0x42
  jmp alltraps
80105dad:	e9 d8 f8 ff ff       	jmp    8010568a <alltraps>
...
80105db4:	6a 43                	push   $0x43
  jmp alltraps
80105db6:	e9 cf f8 ff ff       	jmp    8010568a <alltraps>
...
80105dbd:	6a 44                	push   $0x44
  jmp alltraps
80105dbf:	e9 c6 f8 ff ff       	jmp    8010568a <alltraps>
...
80105dc6:	6a 45                	push   $0x45
  jmp alltraps
80105dc8:	e9 bd f8 ff ff       	jmp    8010568a <alltraps>
...
80105dcf:	6a 46                	push   $0x46
  jmp alltraps
80105dd1:	e9 b4 f8 ff ff       	jmp    8010568a <alltraps>
...
80105dd8:	6a 47                	push   $0x47
  jmp alltraps
80105dda:	e9 ab f8 ff ff       	jmp    8010568a <alltraps>
...
80105de1:	6a 48                	push   $0x48
  jmp alltraps
80105de3:	e9 a2 f8 ff ff       	jmp    8010568a <alltraps>
...
80105dea:	6a 49                	push   $0x49
  jmp alltraps
80105dec:	e9 99 f8 ff ff       	jmp    8010568a <alltraps>
...
80105df3:	6a 4a                	push   $0x4a
  jmp alltraps
80105df5:	e9 90 f8 ff ff       	jmp    8010568a <alltraps>
...
80105dfc:	6a 4b                	push   $0x4b
  jmp alltraps
80105dfe:	e9 87 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e05:	6a 4c                	push   $0x4c
  jmp alltraps
80105e07:	e9 7e f8 ff ff       	jmp    8010568a <alltraps>
...
80105e0e:	6a 4d                	push   $0x4d
  jmp alltraps
80105e10:	e9 75 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e17:	6a 4e                	push   $0x4e
  jmp alltraps
80105e19:	e9 6c f8 ff ff       	jmp    8010568a <alltraps>
...
80105e20:	6a 4f                	push   $0x4f
  jmp alltraps
80105e22:	e9 63 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e29:	6a 50                	push   $0x50
  jmp alltraps
80105e2b:	e9 5a f8 ff ff       	jmp    8010568a <alltraps>
...
80105e32:	6a 51                	push   $0x51
  jmp alltraps
80105e34:	e9 51 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e3b:	6a 52                	push   $0x52
  jmp alltraps
80105e3d:	e9 48 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e44:	6a 53                	push   $0x53
  jmp alltraps
80105e46:	e9 3f f8 ff ff       	jmp    8010568a <alltraps>
...
80105e4d:	6a 54                	push   $0x54
  jmp alltraps
80105e4f:	e9 36 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e56:	6a 55                	push   $0x55
  jmp alltraps
80105e58:	e9 2d f8 ff ff       	jmp    8010568a <alltraps>
...
80105e5f:	6a 56                	push   $0x56
  jmp alltraps
80105e61:	e9 24 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e68:	6a 57                	push   $0x57
  jmp alltraps
80105e6a:	e9 1b f8 ff ff       	jmp    8010568a <alltraps>
...
80105e71:	6a 58                	push   $0x58
  jmp alltraps
80105e73:	e9 12 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e7a:	6a 59                	push   $0x59
  jmp alltraps
80105e7c:	e9 09 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e83:	6a 5a                	push   $0x5a
  jmp alltraps
80105e85:	e9 00 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e8c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e8e:	e9 f7 f7 ff ff       	jmp    8010568a <alltraps>
...
80105e95:	6a 5c                	push   $0x5c
  jmp alltraps
80105e97:	e9 ee f7 ff ff       	jmp    8010568a <alltraps>
...
80105e9e:	6a 5d                	push   $0x5d
  jmp alltraps
80105ea0:	e9 e5 f7 ff ff       	jmp    8010568a <alltraps>
...
80105ea7:	6a 5e                	push   $0x5e
  jmp alltraps
80105ea9:	e9 dc f7 ff ff       	jmp    8010568a <alltraps>
...
80105eb0:	6a 5f                	push   $0x5f
  jmp alltraps
80105eb2:	e9 d3 f7 ff ff       	jmp    8010568a <alltraps>
...
80105eb9:	6a 60                	push   $0x60
  jmp alltraps
80105ebb:	e9 ca f7 ff ff       	jmp    8010568a <alltraps>
...
80105ec2:	6a 61                	push   $0x61
  jmp alltraps
80105ec4:	e9 c1 f7 ff ff       	jmp    8010568a <alltraps>
...
80105ecb:	6a 62                	push   $0x62
  jmp alltraps
80105ecd:	e9 b8 f7 ff ff       	jmp    8010568a <alltraps>
...
80105ed4:	6a 63                	push   $0x63
  jmp alltraps
80105ed6:	e9 af f7 ff ff       	jmp    8010568a <alltraps>
...
80105edd:	6a 64                	push   $0x64
  jmp alltraps
80105edf:	e9 a6 f7 ff ff       	jmp    8010568a <alltraps>
...
80105ee6:	6a 65                	push   $0x65
  jmp alltraps
80105ee8:	e9 9d f7 ff ff       	jmp    8010568a <alltraps>
...
80105eef:	6a 66                	push   $0x66
  jmp alltraps
80105ef1:	e9 94 f7 ff ff       	jmp    8010568a <alltraps>
...
80105ef8:	6a 67                	push   $0x67
  jmp alltraps
80105efa:	e9 8b f7 ff ff       	jmp    8010568a <alltraps>
...
80105f01:	6a 68                	push   $0x68
  jmp alltraps
80105f03:	e9 82 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f0a:	6a 69                	push   $0x69
  jmp alltraps
80105f0c:	e9 79 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f13:	6a 6a                	push   $0x6a
  jmp alltraps
80105f15:	e9 70 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f1c:	6a 6b                	push   $0x6b
  jmp alltraps
80105f1e:	e9 67 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f25:	6a 6c                	push   $0x6c
  jmp alltraps
80105f27:	e9 5e f7 ff ff       	jmp    8010568a <alltraps>
...
80105f2e:	6a 6d                	push   $0x6d
  jmp alltraps
80105f30:	e9 55 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f37:	6a 6e                	push   $0x6e
  jmp alltraps
80105f39:	e9 4c f7 ff ff       	jmp    8010568a <alltraps>
...
80105f40:	6a 6f                	push   $0x6f
  jmp alltraps
80105f42:	e9 43 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f49:	6a 70                	push   $0x70
  jmp alltraps
80105f4b:	e9 3a f7 ff ff       	jmp    8010568a <alltraps>
...
80105f52:	6a 71                	push   $0x71
  jmp alltraps
80105f54:	e9 31 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f5b:	6a 72                	push   $0x72
  jmp alltraps
80105f5d:	e9 28 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f64:	6a 73                	push   $0x73
  jmp alltraps
80105f66:	e9 1f f7 ff ff       	jmp    8010568a <alltraps>
...
80105f6d:	6a 74                	push   $0x74
  jmp alltraps
80105f6f:	e9 16 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f76:	6a 75                	push   $0x75
  jmp alltraps
80105f78:	e9 0d f7 ff ff       	jmp    8010568a <alltraps>
...
80105f7f:	6a 76                	push   $0x76
  jmp alltraps
80105f81:	e9 04 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f88:	6a 77                	push   $0x77
  jmp alltraps
80105f8a:	e9 fb f6 ff ff       	jmp    8010568a <alltraps>
...
80105f91:	6a 78                	push   $0x78
  jmp alltraps
80105f93:	e9 f2 f6 ff ff       	jmp    8010568a <alltraps>
...
80105f9a:	6a 79                	push   $0x79
  jmp alltraps
80105f9c:	e9 e9 f6 ff ff       	jmp    8010568a <alltraps>
...
80105fa3:	6a 7a                	push   $0x7a
  jmp alltraps
80105fa5:	e9 e0 f6 ff ff       	jmp    8010568a <alltraps>
...
80105fac:	6a 7b                	push   $0x7b
  jmp alltraps
80105fae:	e9 d7 f6 ff ff       	jmp    8010568a <alltraps>
...
80105fb5:	6a 7c                	push   $0x7c
  jmp alltraps
80105fb7:	e9 ce f6 ff ff       	jmp    8010568a <alltraps>
...
80105fbe:	6a 7d                	push   $0x7d
  jmp alltraps
80105fc0:	e9 c5 f6 ff ff       	jmp    8010568a <alltraps>
...
80105fc7:	6a 7e                	push   $0x7e
  jmp alltraps
80105fc9:	e9 bc f6 ff ff       	jmp    8010568a <alltraps>
...
80105fd0:	6a 7f                	push   $0x7f
  jmp alltraps
80105fd2:	e9 b3 f6 ff ff       	jmp    8010568a <alltraps>
...
80105fd9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105fde:	e9 a7 f6 ff ff       	jmp    8010568a <alltraps>
...
80105fe5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105fea:	e9 9b f6 ff ff       	jmp    8010568a <alltraps>
...
80105ff1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105ff6:	e9 8f f6 ff ff       	jmp    8010568a <alltraps>
...
80105ffd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106002:	e9 83 f6 ff ff       	jmp    8010568a <alltraps>
...
80106009:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010600e:	e9 77 f6 ff ff       	jmp    8010568a <alltraps>
...
80106015:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010601a:	e9 6b f6 ff ff       	jmp    8010568a <alltraps>
...
80106021:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106026:	e9 5f f6 ff ff       	jmp    8010568a <alltraps>
...
8010602d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106032:	e9 53 f6 ff ff       	jmp    8010568a <alltraps>
...
80106039:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010603e:	e9 47 f6 ff ff       	jmp    8010568a <alltraps>
...
80106045:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010604a:	e9 3b f6 ff ff       	jmp    8010568a <alltraps>
...
80106051:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106056:	e9 2f f6 ff ff       	jmp    8010568a <alltraps>
...
8010605d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106062:	e9 23 f6 ff ff       	jmp    8010568a <alltraps>
...
80106069:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010606e:	e9 17 f6 ff ff       	jmp    8010568a <alltraps>
...
80106075:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010607a:	e9 0b f6 ff ff       	jmp    8010568a <alltraps>
...
80106081:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106086:	e9 ff f5 ff ff       	jmp    8010568a <alltraps>
...
8010608d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106092:	e9 f3 f5 ff ff       	jmp    8010568a <alltraps>
...
80106099:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010609e:	e9 e7 f5 ff ff       	jmp    8010568a <alltraps>
...
801060a5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801060aa:	e9 db f5 ff ff       	jmp    8010568a <alltraps>
...
801060b1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060b6:	e9 cf f5 ff ff       	jmp    8010568a <alltraps>
...
801060bd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060c2:	e9 c3 f5 ff ff       	jmp    8010568a <alltraps>
...
801060c9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060ce:	e9 b7 f5 ff ff       	jmp    8010568a <alltraps>
...
801060d5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060da:	e9 ab f5 ff ff       	jmp    8010568a <alltraps>
...
801060e1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060e6:	e9 9f f5 ff ff       	jmp    8010568a <alltraps>
...
801060ed:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801060f2:	e9 93 f5 ff ff       	jmp    8010568a <alltraps>
...
801060f9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801060fe:	e9 87 f5 ff ff       	jmp    8010568a <alltraps>
...
80106105:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010610a:	e9 7b f5 ff ff       	jmp    8010568a <alltraps>
...
80106111:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106116:	e9 6f f5 ff ff       	jmp    8010568a <alltraps>
...
8010611d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106122:	e9 63 f5 ff ff       	jmp    8010568a <alltraps>
...
80106129:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010612e:	e9 57 f5 ff ff       	jmp    8010568a <alltraps>
...
80106135:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010613a:	e9 4b f5 ff ff       	jmp    8010568a <alltraps>
...
80106141:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106146:	e9 3f f5 ff ff       	jmp    8010568a <alltraps>
...
8010614d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106152:	e9 33 f5 ff ff       	jmp    8010568a <alltraps>
...
80106159:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010615e:	e9 27 f5 ff ff       	jmp    8010568a <alltraps>
...
80106165:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010616a:	e9 1b f5 ff ff       	jmp    8010568a <alltraps>
...
80106171:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106176:	e9 0f f5 ff ff       	jmp    8010568a <alltraps>
...
8010617d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106182:	e9 03 f5 ff ff       	jmp    8010568a <alltraps>
...
80106189:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010618e:	e9 f7 f4 ff ff       	jmp    8010568a <alltraps>
...
80106195:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010619a:	e9 eb f4 ff ff       	jmp    8010568a <alltraps>
...
801061a1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801061a6:	e9 df f4 ff ff       	jmp    8010568a <alltraps>
...
801061ad:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061b2:	e9 d3 f4 ff ff       	jmp    8010568a <alltraps>
...
801061b9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061be:	e9 c7 f4 ff ff       	jmp    8010568a <alltraps>
...
801061c5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061ca:	e9 bb f4 ff ff       	jmp    8010568a <alltraps>
...
801061d1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061d6:	e9 af f4 ff ff       	jmp    8010568a <alltraps>
...
801061dd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061e2:	e9 a3 f4 ff ff       	jmp    8010568a <alltraps>
...
801061e9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061ee:	e9 97 f4 ff ff       	jmp    8010568a <alltraps>
...
801061f5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801061fa:	e9 8b f4 ff ff       	jmp    8010568a <alltraps>
...
80106201:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106206:	e9 7f f4 ff ff       	jmp    8010568a <alltraps>
...
8010620d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106212:	e9 73 f4 ff ff       	jmp    8010568a <alltraps>
...
80106219:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010621e:	e9 67 f4 ff ff       	jmp    8010568a <alltraps>
...
80106225:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010622a:	e9 5b f4 ff ff       	jmp    8010568a <alltraps>
...
80106231:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106236:	e9 4f f4 ff ff       	jmp    8010568a <alltraps>
...
8010623d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106242:	e9 43 f4 ff ff       	jmp    8010568a <alltraps>
...
80106249:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010624e:	e9 37 f4 ff ff       	jmp    8010568a <alltraps>
...
80106255:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010625a:	e9 2b f4 ff ff       	jmp    8010568a <alltraps>
...
80106261:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106266:	e9 1f f4 ff ff       	jmp    8010568a <alltraps>
...
8010626d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106272:	e9 13 f4 ff ff       	jmp    8010568a <alltraps>
...
80106279:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010627e:	e9 07 f4 ff ff       	jmp    8010568a <alltraps>
...
80106285:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010628a:	e9 fb f3 ff ff       	jmp    8010568a <alltraps>
...
80106291:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106296:	e9 ef f3 ff ff       	jmp    8010568a <alltraps>
...
8010629d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801062a2:	e9 e3 f3 ff ff       	jmp    8010568a <alltraps>
...
801062a9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801062ae:	e9 d7 f3 ff ff       	jmp    8010568a <alltraps>
...
801062b5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062ba:	e9 cb f3 ff ff       	jmp    8010568a <alltraps>
...
801062c1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062c6:	e9 bf f3 ff ff       	jmp    8010568a <alltraps>
...
801062cd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062d2:	e9 b3 f3 ff ff       	jmp    8010568a <alltraps>
...
801062d9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062de:	e9 a7 f3 ff ff       	jmp    8010568a <alltraps>
...
801062e5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062ea:	e9 9b f3 ff ff       	jmp    8010568a <alltraps>
...
801062f1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801062f6:	e9 8f f3 ff ff       	jmp    8010568a <alltraps>
...
801062fd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106302:	e9 83 f3 ff ff       	jmp    8010568a <alltraps>
...
80106309:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010630e:	e9 77 f3 ff ff       	jmp    8010568a <alltraps>
...
80106315:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010631a:	e9 6b f3 ff ff       	jmp    8010568a <alltraps>
...
80106321:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106326:	e9 5f f3 ff ff       	jmp    8010568a <alltraps>
...
8010632d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106332:	e9 53 f3 ff ff       	jmp    8010568a <alltraps>
...
80106339:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010633e:	e9 47 f3 ff ff       	jmp    8010568a <alltraps>
...
80106345:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010634a:	e9 3b f3 ff ff       	jmp    8010568a <alltraps>
...
80106351:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106356:	e9 2f f3 ff ff       	jmp    8010568a <alltraps>
...
8010635d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106362:	e9 23 f3 ff ff       	jmp    8010568a <alltraps>
...
80106369:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010636e:	e9 17 f3 ff ff       	jmp    8010568a <alltraps>
...
80106375:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010637a:	e9 0b f3 ff ff       	jmp    8010568a <alltraps>
...
80106381:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106386:	e9 ff f2 ff ff       	jmp    8010568a <alltraps>
...
8010638d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106392:	e9 f3 f2 ff ff       	jmp    8010568a <alltraps>
...
80106399:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010639e:	e9 e7 f2 ff ff       	jmp    8010568a <alltraps>
...
801063a5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801063aa:	e9 db f2 ff ff       	jmp    8010568a <alltraps>
...
801063b1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063b6:	e9 cf f2 ff ff       	jmp    8010568a <alltraps>
...
801063bd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063c2:	e9 c3 f2 ff ff       	jmp    8010568a <alltraps>
...
801063c9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063ce:	e9 b7 f2 ff ff       	jmp    8010568a <alltraps>
...
801063d5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063da:	e9 ab f2 ff ff       	jmp    8010568a <alltraps>
...
801063e1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063e6:	e9 9f f2 ff ff       	jmp    8010568a <alltraps>
...
801063ed:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801063f2:	e9 93 f2 ff ff       	jmp    8010568a <alltraps>
...
801063f9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801063fe:	e9 87 f2 ff ff       	jmp    8010568a <alltraps>
...
80106405:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010640a:	e9 7b f2 ff ff       	jmp    8010568a <alltraps>
...
80106411:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106416:	e9 6f f2 ff ff       	jmp    8010568a <alltraps>
...
8010641d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106422:	e9 63 f2 ff ff       	jmp    8010568a <alltraps>
...
80106429:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010642e:	e9 57 f2 ff ff       	jmp    8010568a <alltraps>
...
80106435:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010643a:	e9 4b f2 ff ff       	jmp    8010568a <alltraps>
...
80106441:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106446:	e9 3f f2 ff ff       	jmp    8010568a <alltraps>
...
8010644d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106452:	e9 33 f2 ff ff       	jmp    8010568a <alltraps>
...
80106459:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010645e:	e9 27 f2 ff ff       	jmp    8010568a <alltraps>
...
80106465:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010646a:	e9 1b f2 ff ff       	jmp    8010568a <alltraps>
...
80106471:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106476:	e9 0f f2 ff ff       	jmp    8010568a <alltraps>
...
8010647d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106482:	e9 03 f2 ff ff       	jmp    8010568a <alltraps>
...
80106489:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010648e:	e9 f7 f1 ff ff       	jmp    8010568a <alltraps>
...
80106495:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010649a:	e9 eb f1 ff ff       	jmp    8010568a <alltraps>
...
801064a1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801064a6:	e9 df f1 ff ff       	jmp    8010568a <alltraps>
...
801064ad:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801064b2:	e9 d3 f1 ff ff       	jmp    8010568a <alltraps>
...
801064b9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064be:	e9 c7 f1 ff ff       	jmp    8010568a <alltraps>
...
801064c5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064ca:	e9 bb f1 ff ff       	jmp    8010568a <alltraps>
...
801064d1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064d6:	e9 af f1 ff ff       	jmp    8010568a <alltraps>
...
801064dd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064e2:	e9 a3 f1 ff ff       	jmp    8010568a <alltraps>
...
801064e9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064ee:	e9 97 f1 ff ff       	jmp    8010568a <alltraps>
...
801064f5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801064fa:	e9 8b f1 ff ff       	jmp    8010568a <alltraps>
...
80106501:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106506:	e9 7f f1 ff ff       	jmp    8010568a <alltraps>
...
8010650d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106512:	e9 73 f1 ff ff       	jmp    8010568a <alltraps>
...
80106519:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010651e:	e9 67 f1 ff ff       	jmp    8010568a <alltraps>
...
80106525:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010652a:	e9 5b f1 ff ff       	jmp    8010568a <alltraps>
...
80106531:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106536:	e9 4f f1 ff ff       	jmp    8010568a <alltraps>
...
8010653d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106542:	e9 43 f1 ff ff       	jmp    8010568a <alltraps>
...
80106549:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010654e:	e9 37 f1 ff ff       	jmp    8010568a <alltraps>
...
80106555:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010655a:	e9 2b f1 ff ff       	jmp    8010568a <alltraps>
...
80106561:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106566:	e9 1f f1 ff ff       	jmp    8010568a <alltraps>
...
8010656d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106572:	e9 13 f1 ff ff       	jmp    8010568a <alltraps>
...
80106579:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010657e:	e9 07 f1 ff ff       	jmp    8010568a <alltraps>
...
80106585:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010658a:	e9 fb f0 ff ff       	jmp    8010568a <alltraps>
...
80106591:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106596:	e9 ef f0 ff ff       	jmp    8010568a <alltraps>
...
8010659d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801065a2:	e9 e3 f0 ff ff       	jmp    8010568a <alltraps>
...
801065a9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801065ae:	e9 d7 f0 ff ff       	jmp    8010568a <alltraps>
...
801065b5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065ba:	e9 cb f0 ff ff       	jmp    8010568a <alltraps>
...
801065c1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065c6:	e9 bf f0 ff ff       	jmp    8010568a <alltraps>
...
801065cd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065d2:	e9 b3 f0 ff ff       	jmp    8010568a <alltraps>
...
801066dd:	68 e8 77 10 80       	push   $0x801077e8
...
80106793:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106796:	e8 55 cf ff ff       	call   801036f0 <cpuid>
...
80106820:	a1 a4 77 11 80       	mov    0x801177a4,%eax
{
...
80106864:	0f 84 c2 00 00 00    	je     8010692c <switchuvm+0xec>
  pushcli();
8010686a:	e8 61 da ff ff       	call   801042d0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010686f:	e8 fc cd ff ff       	call   80103670 <mycpu>
80106874:	89 c6                	mov    %eax,%esi
80106876:	e8 f5 cd ff ff       	call   80103670 <mycpu>
8010687b:	89 c7                	mov    %eax,%edi
8010687d:	e8 ee cd ff ff       	call   80103670 <mycpu>
80106882:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106885:	83 c7 08             	add    $0x8,%edi
80106888:	e8 e3 cd ff ff       	call   80103670 <mycpu>
...
8010697f:	e8 2c db ff ff       	call   801044b0 <memset>
...
801069b0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801069b1:	e9 aa db ff ff       	jmp    80104560 <memmove>
    panic("inituvm: more than a page");
801069b6:	83 ec 0c             	sub    $0xc,%esp
801069b9:	68 2d 78 10 80       	push   $0x8010782d
...
80106adb:	e8 d0 d9 ff ff       	call   801044b0 <memset>
...
80106b1d:	68 65 78 10 80       	push   $0x80107865
...
80106b53:	68 7d 78 10 80       	push   $0x8010787d
...
80106c5c:	68 99 78 10 80       	push   $0x80107899
...
80106c90:	e8 1b d8 ff ff       	call   801044b0 <memset>
...
80106cfb:	a3 a4 77 11 80       	mov    %eax,0x801177a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106d2f:	68 aa 78 10 80       	push   $0x801078aa
...
80106d80:	e8 db d7 ff ff       	call   80104560 <memmove>
...
80106e19:	68 ce 78 10 80       	push   $0x801078ce
80106e1e:	e8 6d 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106e23:	83 ec 0c             	sub    $0xc,%esp
80106e26:	68 b4 78 10 80       	push   $0x801078b4
...
80106eaf:	e8 ac d6 ff ff       	call   80104560 <memmove>
    len -= n;
    buf += n;
